  ...
  <tr>
    ...
    <td align="left" valign="top" class="ctr"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
        ...
        <table width="649"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td valign="top"><p><br>
              <span class="t4">Landscaping</span>
              <hr style="border: solid 1px #990000;" />
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td><span class="t4">Water Feature</span><br>
                      <br />
                      <img src="img/photos/8.jpg" width="487" height="329"> </td>
                  <td style="padding-left:10px;"><span class="t4">Aerial View</span><br>
                      <br />
                      <img src="img/photos/9.jpg" width="487" height="329"> </td>
                </tr>
              </table>
               <p><br><span class="t4">Clubhouse Vicinity</span>

              <hr style="border: solid 1px #990000;" />
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td><span class="t4">Clubhouse</span><br>
                      <br />
                      <img src="img/photos/10.jpg" width="487" height="329"> </td>
                  <td style="padding-left:10px;"><span class="t4">Clubhouse</span><br>
                      <br />
                      <img src="img/photos/11.jpg" width="487" height="329"> </td>
                </tr>
				 <tr>
                  <td  style="padding-top:10px;"><span class="t4">Gymnasium</span><br>
                    <br />
                    <img src="img/photos/12.jpg" width="487" height="329"></td>
				 <td style="padding-top:10px;padding-left:10px;"><span class="t4">Function Room</span><br><br />
              <img src="img/photos/13.jpg" width="487" height="329">
            </td>
                </tr>
                <tr>
                  <td style="padding-top:10px;" colspan="2"><span class="t4">Clubhouse</span><br>
                      <br />
                      <img src="img/photos/14.jpg" width="608" height="247"> </td>
                </tr>
               
              </table>
               <p><br><span class="t4">Pool Area</span>
              <hr style="border: solid 1px #990000;" />
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
            ...
            <p>              <br>
              <span class="t4">Basement Facility</span>
            <hr style="border: solid 1px #990000;" />
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
			            <tr>
              <td style="padding-top:10px; "><span class="t4">Storage Lockers</span><br>
                <br />
                <img src="img/photos/17.jpg" width="487" height="329"></td>
              <td style="padding-left:10px;">&nbsp;</td>
            </tr>
            <tr>
            <td style="padding-top:10px; "><span class="t4">Basement Carpark</span><br><br />
