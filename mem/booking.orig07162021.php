...
?>
        ...
        <?php
            if(isset($_GET['cr']) AND isset($_GET['pr'])){
                    ...
                    <td colspan="3">
                        <form name="form" method="post" action="">
                            ...
                            <table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td colspan="13" bgcolor="#944542" class="fontitle txtgrey" style="border-left:0px solid #b09852;border-right:1px solid #b09852; padding-left:15px; padding-top:5px; padding-bottom:5px;">
                                        <span class="fontitle">&nbsp;<strong>Basic Details </strong></span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5" style="padding-left:15px; padding-top:5px; padding-bottom:5px;">
                                        <label>
                                    ...
                                    <td width="143" style="padding-left:15px; padding-top:5px; padding-bottom:5px; border-right:0px solid #990011;"><b> &nbsp;
                                        ...
                                        <input type="hidden" name="creation_date" value="<?php echo $date; ?>">
                                    </td>
                                    ...
                                    <td width="144" style="padding-left:15px; padding-top:5px; padding-bottom:5px; border-right:1px solid #990011;">
                                        <select name="type">
                                ...
                                <tr>
                                    ...
                                    <td colspan="13" bgcolor="#944542" style="border-left:1px solid #b09852;border-right:1px solid #b09852; padding-left:15px; padding-top:5px; padding-bottom:5px;">
                                        <span class="fontitle"><strong>&nbsp;Booking Time Range </strong></span>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <table width="100%" border="0" align="center" class="sk_bok" cellpadding="5" cellspacing="0">
                                        ...
                                        <tr>
                                            ...
                                            <td width="4%" bgcolor="#FCECC7">
                                                <div align="center">
                                                    <strong>Sno</strong>
                                                </div>
                                            </td>

                                            <td width="23%" bgcolor="#FCECC7" style="border-left:1px solid #990011;">
                                                <div align="center">
                                                    <strong>From</strong>
                                                </div>
                                            </td>
                                            ...
                                            <td width="21%" bgcolor="#FCECC7" style="border-left:1px solid #990011;">
                                                <div align="center">
                                                    <strong>Peak / Non Peak</strong> 
                                                </div>
                                            </td>
                                ...
                                <tr>
                                    <td colspan="13" bgcolor="#944542" style="border-left:1px solid #b09852;border-right:1px solid #b09852; padding-left:15px; padding-top:5px; padding-bottom:5px;">
                                        <span class="fontitle"><strong>&nbsp;Advance Rules </strong></span>
                                    </td>
                                </tr>
                                    ...
                                    <td colspan="13" style="border-left:1px solid #990011; border-right:1px solid #990011; border-bottom:1px solid #990011;">
                                        <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
                                            ...
                                            <tr>
                                                ...
                                                <td><strong>:</strong></td>
                                                <td>
                                                    <input name="deposite" type="text" value="<?php echo $_SESSION['facility']['deposite']; ?>" size="5" maxlength="5" tooltipText="Enter the amount which will be displayed to user while booking the facilities and receipt of same will be issued. If the amount is ZERO then it will be considered as NO CHARGES" 
                                                    <?php echo $disabled;?> >
                                                </td>
                                                ...
                                                <td colspan="8">
                                                    ...
                                                    <input name="auto" type="checkbox" value="1" <?php echo $checked; ?> tooltipText="Do you want system to auto aprove the booking as soon as it is requested" <?php echo $disabled; ?>>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td colspan="13">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="30%" rowspan="6" valign="top">
                                                                <div align="justify">Note : <br>
                                                                    All rules and limit will be ignored below the step where N/A is selected. For example if you have selected Rule 1 as N/A in first drop down box then Rule 2 and rule 3 will be ignored. 
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                    ...
                                                    <?php // somebody tell me why is this empty. Next time, if want to use dreamweaver, make sure you understand the code also. Dont be too dependent on the easy drag and drop features. ?>
                                            ...
                                            <tr>
                                                <td colspan="10" bgcolor="#FDF5E1">
                                                    ...
                                                    <label>Hrs
                                                        <input type="hrs" name="hrs" class="CONFLICTS WITH apache AND DEPENDS ON os BEING time_based" maxlength="5" size="5"  tooltiptext="Define how many hours will be defined as one session. (e.g 4 , if you enter 4 then system will take one booking for 4 hour)" 
                                                            <?php echo $disabled; ?> value="<?php echo $_SESSION['facility']['hrs']; ?>">
                                                    </label>
                                            ...
                                            <tr>
                                                <td colspan="13" bgcolor="#FCECC7">Auto Close Date
                                                    <label>
                                                        ...
                                                        ?>
                                                        <input type="checkbox" name="auto_close" value="1" <?php echo $disabled;?> tooltiptext="Check this box if you want system to close the booking of this facilitie at given data on either every mont or year." 
                                                            <?php echo $auto_close_1;?>>
                                                    </label>                        
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td width="20%">
                                                    <label>
                                                        ...
                                                        <img src="images/icon-calender.gif" width="19" height="18"  onclick="displayCalendar(document.forms[0].from_date,'dd.mm.yyyy',this)" value="Cal">
                                                    </label>
                                                </td>
                                                <td width="13%">&nbsp;</td>
                                                <td width="7%">To</td>
              	...
              	<tr> 
                	...
                	<td style="border-left:1px solid #990011; border-top:1px solid #990011;"> 
                  		<div align="center"> 
                            ...
                            <a href="booking.php?crypted=<?php echo $_GET['crypted']."&page=view&dele=".$row['sno']; ?>" onClick="return confirm('Deleting this facility will affect the booking report. Are you sure you want to delete this facility?');">
                                <font color="#993300">Delete</font>
                            </a>
                        </div>
                    </td>
...
?>
            ...
            <p>
                <b>To place online bookings, please select the respective facility and click on [ Book Now ] Button. </b> 
            </p>
            <p><b><font color="#FF0000">Note:</font></b><br>
            ...
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                	<td style="background-repeat:no-repeat">
                        <div align="right">
                            <img src="images/left_win_10.gif" width="21" height="30" border="0">
                        </div>
                    </td>
                    <td width="100%" background="images/middle_win_11.gif">
                        <span class="fontitle style1"><strong>Edit Facilities</strong></span>
                    </td>
                    <td><img src="images/right_win_14.gif" width="17" height="30"></td>
                </tr>
                ...
                <tr>
                	<td colspan="3"><form name="form" method="post" action="">
                        <table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
                            <tr>
                                <td colspan="13" bgcolor="#944542" class="fontitle txtgrey" style="border-left:1px solid #b09852;border-right:1px solid #b09852; padding-left:15px; padding-top:5px; padding-bottom:5px;">
                                    <span class="fontitle">&nbsp;<strong>Basic Details </strong></span>
                                </td>
                            </tr>
                    ...
                    ?>
                        ...
                        <?php
                            $sr++;
                        } // END Of WHILE Time track dito na..
                        ?>
...
if (isset($_POST[type]) && $_POST[type] == 'cancle') {
    ...
    if ($_POST['reason'] == '1' or $_POST['reason'] == '2' or $_POST['reason'] == '3' or $_POST['reason'] == '4' or $_POST['reason'] == '5' or $_POST['reason'] == '6' or $_POST['reason'] == '7' or $_POST['reason'] == '8' or $_POST['reason'] == '9' or $_POST['reason'] == '10' or $_POST['reason'] == '11' or $_POST['reason'] == '12') {
        ...
        $resultbooked        = mysqli_query($sqlbooked);
        ...
        $resultfacility      = mysqli_query($sqlfacility);
        ...
        $resultremarks       = mysqli_query($sqlremarks);
        ...
        $resultresident      = mysqli_query($sqlresident);
        ...
        $resultcancelby      = mysqli_query($sqlcancelby);
    ...
    if ($_SESSION['user_type'] == 2) {
        ...
        $resultclub = mysqli_query($queryclub) or die(mysqli_error($conn));
...
?>
    ...
    $result_facility  = mysqli_query($check_facility);
    ...
    while ($sr <= 2) {
        ...
        $result_sql   = mysqli_query($check_sql);
        ...
        $result_facility1st = mysqli_query($sql_facility1st);
        ...
        $result_find        = mysqli_query($sql_find);
...
?>">Absent</a> ]
                    ...
                    $resultoutdoor = mysqli_query($sqloutdoor);
        ...
        if (isset($_POST[Submit4])) {
            ...
            if ($is_there == '0') {
                ...
                if ($is_there != '0' && $user_type != 1) {
                    ...
                    $result_check    = mysqli_query($sql_check);
                    ...
                    if ($num_check != 0) {
                        while ($row_check = mysqli_fetch_array($result_check)) {
                            ...
                            if ($tochecklower >= $dateLOWERlimit1 && $tochecklower <= $dateUPPERlimit2) {
                                ...
                                $result_holiday = mysqli_query($sql_holiday);
                    ...
                    $result_holidaycheck = mysqli_query($sql_holidaycheck);
...
Holiday. You can make the next booking 2 months after your first booking.")';
                        ...
                        $resultchecking   = mysqli_query($checkingsql);
                        ...
                        if (($user_type != '1') && ($tennisCourt1 || $tennisCourt2)) {
                            ...
                            $res_tenniz   = mysqli_query($tenniz);
...
?>
    ...
    if ($error != '1') {
        ...
        $resultgroup  = mysqli_query($sqlgroup);
        ...
        $resultothers = mysqli_query($sqlothers);
        ...
        $result_facility = mysqli_query($query_facility);
    ...
    if (($unique_no == '1193717225' || $unique_no == '1198430241') && $user_type_booked != '1') {
        ...
        $resulttennis = mysqli_query($sqltennis);
    ...
    if (($unique_no == '1294727326' || $unique_no == '1294727362') && $user_type_booked != '1') {
        ...
        $resultpools = mysqli_query($sqlpools);
...
?>
        ...
        $resultbar = mysqli_query($sqlbar) or mysqli_error($conn);
                            ...
                            if ($dont_sel == '' || $dont_sel != '') {
                                ...
                                while ($row_my = mysqli_fetch_array($result_my_query)) {
                                    ...
                                    if ($fram_user_from_time == $from_time) {
                                        ...
                                        $query_result             = mysqli_query($query_user);
...
?>
            ...
            Facility is currently closed from  <?php
...
?>
		    ...
		    <td bgcolor="#994947" style="border-left:1px solid #333333;"> 
              ...
              <div align="center" class="fontitle">Receipt</div></td> <?php
            }
?>
...
?>
                    ...
                    <tr>
                        ...
                        <form name="form_1" method="post" action="?page=all&crypted=<?php
    echo $_GET[crypted];
?>" <?php
    if ($user_type == '0') {
?>onSubmit="return validate()"<?php
    }
?>>
...
?>
                          ...
                          <input type="hidden" name="user_sel" value="<?php
        echo $id;
?>"><select name="select">
...
?>','','status=no,width=850,height=600,toolbar=no,titlebar=no,resizable=yes,scrollbars=yes')">print</a> ]</td>
                                ...
                                <tr>
                                  ...
                                  <td width="11%" bgcolor="#944542" style="border-right:1px solid #333333;"><div align="center" class="fontitle"><?php
        if ($user_type != '0') {
?><a href="booking.php?page=all&select=<?php
...
?>&crypted=<?php
            echo $_GET[crypted];
?>&sort=facility&date_sel_all=<?php
            if (isset($_POST[date_sel_all])) {
                echo $_POST[date_sel_all];
            } else {
                echo $_GET[date_sel_all];
            }
?>&date_sel_all_end=<?php
            if (isset($_POST[date_sel_all_end])) {
                echo $_POST[date_sel_all_end];
            } else {
                echo $_GET[date_sel_all_end];
            }
?>"><font color="#FFFFFF">Facility</font></a><?php
        } else {
?>Facility<?php
        }
?></div></td>

                                  <td width="8%" bgcolor="#944542" style="border-right:1px solid #333333;"><div align="center" class="fontitle"><?php
        if ($user_type != '0') {
?><a href="booking.php?page=all&select=<?php
            if (isset($_POST[select])) {
                echo $_POST[select];
...
?>"><font color="#FFFFFF">Date</font></a><?php
        } else {
?>Date<?php
        }
?></div></td>
...
?>
                                  ...
                                  <td width="5%" bgcolor="#944542" style="border-right:1px solid #333333;"><div align="center" class="fontitle">Deposit Status</div></td> <?php
        if ($user_type == '0') {
?>

                                  <td width="7%" bgcolor="#944542"><div align="center" class="fontitle">Remarks</div></td> <?php
        }
?><?php
        if ($user_type != '0') {
?>
								  ...
								  <td width="9%" bgcolor="#944542" style="border-left:1px solid #333333;"><div align="center" class="fontitle">Receipt</div></td><?php
        }
?>
...
?>
                ...
                if ($user_type == '1' || $rid2 == $id) {
                    ...
                    $resultcheckbooker = mysqli_query($sqlcheckbooker);
...
?>
											...
											[ <a href="redirect.php?crypted=<?php
                        echo $_GET[crypted];
?>&id=<?php
                        echo $fac;
?>&page=<?php
...
?>&select=<?php
                            echo $_POST[select];
?>'>Approve</a> ] [ <a href="redirect.php?crypted=<?php
                            echo $_GET[crypted];
?>&id=<?php
                            echo $fac;
?>&page=<?php
...
?><br>[<a href="redirect.php?crypted=<?php
                        echo $_GET[crypted];
?>&id=<?php
                        echo $fac;
?>&page=<?php
...
?>                                    		&nbsp;&nbsp; 
                ...
                if ($row[cancelled_by] != '' && $row[cancelled_by] != '0') {
                    ...
                    $resultuser = mysqli_query($queryuser) or die(mysqli_error($conn));
                    //$count = mysqli_num_rows($result);
