...
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <tr><td align="left" vAlign="top" bgcolor="#FFFFFF" background="img/leftctrbg2.gif">
  <link href="../textset.css" type="text/css" rel="stylesheet">
    ...
    <tr>
      <td><table cellSpacing="0" cellPadding="0" width="100%" border="0" id="table6">
          <tr>
...
height="3"></SPACER></td>
    ...
    <tr>
      <td class="leftcontent" height="3"><img height="7" src="img/leftdot.gif" width="9"> <a class="copy" href="community.php?crypted=<? echo $_GET['crypted']; ?>#community">Community News</a></td>
    </tr>
    <tr>
      <td class="leftdecline" height="3"><SPACER type="block" 
height="3"></SPACER></td>
    ...
    <tr>
      <td class="leftcontent"><img height="7" src="img/leftdot.gif" width="9"> <a class="copy" href="community.php?crypted=<? echo $_GET['crypted']; ?>#circulars">Circulars</a></td>
    </tr>
    <tr>
      <td class="leftdecline" height="3"><SPACER type="block" 
height="3"></SPACER></td>
    ...
    <tr>
      <td class="leftcontent"><img height="7" src="../img/leftdot.gif" width="9"> <a class="copy" href="comm.php?crypted=<? echo $_GET['crypted']; ?>&calender">Calendar Of Events </a></td>
    </tr>
  </table></td>
