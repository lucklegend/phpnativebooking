		...
		<table cellSpacing="0" cellPadding="0" width="100%" border="0" id="table7">
			...
			<tr>
				...
				New Password'. Click 'OK' to proceed.</p> <? } else if ($msg == '1') {?>
   				Please ensure your current password is correct. Please re-enter and click 'OK' to proceed.</p><? } else if ($msg == '2') {?><b>Your new password has been successfully changed.</b></p> <? } else if ($msg == '3')  { ?> <b style="color: red;" >Password Must be Alpha Numeric.</b></p> <? }  else if ($msg == '4')  {  ?> <b style="color: red;" >New Password and Confirm Password Doesnt match.</b></p> <? }  ?>
                <? if ($user_type == 0) { ?>
				<form name="form1" onsubmit="return validate()" method="post" action="profile.php?crypted=<? echo $_GET['crypted']; ?>">
