...
if(isset($_POST['update']))
{
	...
	$query = "UPDATE useful_info SET category = '$description', telephone = '$tel', mobile = '$mobile',contact='$contact', fax = '$fax', display_name = '$name', address = '$address', url = '$url' WHERE id = '$moreid'";
	$result = mysql_query($query) or die(mysql_error()) ; 
		
	echo "<script type=text/javascript language=javascript> 
	alert('Useful Info updated successfully');
	window.location.href = 'useful.php?crypted=" . $_GET['crypted'] . "'; </script> ";
		  ...
		  <input type="hidden" value="useful info" name="ty">
			...
			<table cellSpacing="0" cellPadding="0" align="left" border="0" id="table8">
				<tr>
					...
					<textarea onkeyup="count(this,200)" style="WIDTH: 27.6em" name="description" rows="4" cols="20"><? echo $category; ?></textarea>
					<br>
