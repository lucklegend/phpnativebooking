...
{
print "     <td id=ignore width =308 height=100></td>";  // Empty slots 
$slot++;
}
	if($day == '')
	{
...
print "<tr align=center width =50>\n"; // move on to next row
	...
	if ($red >= 1)
	{
	echo "<td  $color id=$idd width =308 height=100 valign=top><DIV align=center id= tips><a href = #><font color=black><a href=comm.php?crypted=$_GET[crypted]&last=$month_no&year=$db_date_search[2]&calender&add_event=$db_date_search[0]-$db_date_search[1]-$db_date_search[2]><font color=red>$day</font></a> </font>
		
		 ";
	}
	else
	{
	echo "<td  $color id=$idd width =308 height=100 valign=top><DIV align=center id= tips><a href = #><font color=black><a href=comm.php?crypted=$_GET[crypted]&last=$month_no&year=$db_date_search[2]&calender&add_event=$db_date_search[0]-$db_date_search[1]-$db_date_search[2]><font color=black>$day</font></a> </font>
