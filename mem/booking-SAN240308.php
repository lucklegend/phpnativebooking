			   ...
			   while($row=mysql_fetch_array($result))
			   {
		    		...
		    		if($row[os] == 'sess')
              		...
              		<tr> 
                		...
                		<td style="border-left:1px solid #990011; border-top:1px solid #990011;"> 
                  		<div align="center"> <a href="booking.php?crypted=<?php echo $_GET[crypted]; ?>&page=edit&facility=<?php echo $row[sno]; ?>"> 
                  		Edit
                  		</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href=booking.php?crypted=<?php echo "$_GET[crypted]&page=view&dele=$row[sno]"; ?> onClick="return confirm('Deleting this facility will affect the booking report. Are you sure you want to delete this facility?');"><font color="#993300">Delete</font></a></div>                		</td>
           		    </tr>
              		<?
					$sr++;
					}
			...
			mysql_query($query);
                ...
                <tr>
					...
					if(isset($_POST[type]) && $_POST[type] == 'approve')
					{
						...
						?>
                        <table width="100%" border="0" align="center">
                      		<form name="form1" method="post" action="booking.php?crypted=<?php echo $_GET[crypted]; ?>&id=<?php echo $_GET[id]; ?>&page=<?php echo $_GET[page]; ?>&user_id=<?php echo $_GET[user_id]; ?>&fac=<?php echo $_GET[fac]; ?>&newbook=0">
                            <tr>
                            <td colspan="9">
						...
						<? 
										...
										if ($user_type == '0')
										{
											if ($registered_by_id == $id || $rid == $id)
											{
												...
												if ($order_status == '0')
												{
													...
													{
													?>
													[ <a href="redirect.php?<?php echo "crypted=$_GET[crypted]&id=$_GET[id]&page=book_now&user_id=$_GET[user_id]&fac=$_GET[fac]&date_sel=$curent_date&booking_no=$my_booking_no&type=cancle&reason=1"; ?>">Cancel</a> ]
													<?
													}
												}
												else
												if ($order_status == '1')
												{
													...
													{
													?>
													[ <a href="redirect.php?<?php echo "crypted=$_GET[crypted]&id=$_GET[id]&page=book_now&user_id=$_GET[user_id]&fac=$_GET[fac]&date_sel=$curent_date&booking_no=$my_booking_no&type=cancle&reason=2"; ?>">Cancel</a> ]
													<?
													}
												}
												else
										...
										if ($user_type == '1')
										{
											if ($order_status == '0')
											{
												...
												{
												?> 
                                                [ <a href="redirect.php?<?php echo 'crypted=$_GET[crypted]&id=$_GET[id]&page=book_now&user_id=$_GET[user_id]&fac=$_GET[fac]&date_sel=$curent_date&booking_no=$my_booking_no&type=approve'; ?>">Approve</a> ] [ <a href="redirect.php?<?php echo 'crypted=$_GET[crypted]&id=$_GET[id]&page=book_now&user_id=$_GET[user_id]&fac=$_GET[fac]&date_sel=$curent_date&booking_no=$my_booking_no&type=cancle&reason=9'; ?>">Cancel</a> ]
                                                  <?
												}  
											}
											else
											if ($order_status == '1')
											{
												...
												{
												?>
                                                [ <a href="redirect.php?<?php echo 'crypted=$_GET[crypted]&id=$_GET[id]&page=book_now&user_id=$_GET[user_id]&fac=$_GET[fac]&date_sel=$curent_date&booking_no=$my_booking_no&type=cancle&reason=8'; ?>">Cancel</a> ]
                                                <?
												}
												...
												{
												?>
                                                [ <a href="redirect.php?<?php echo 'crypted=$_GET[crypted]&id=$_GET[id]&page=book_now&user_id=$_GET[user_id]&fac=$_GET[fac]&date_sel=$curent_date&booking_no=$my_booking_no&type=cancle&reason=9'; ?>">Cancel</a> ]
                                                <?
												}
										...
										if ($user_type == '2')
										{
											if ($order_status == '0')
											{
												...
												{
												?>
                                                [ <a href="redirect.php?<?php echo "crypted=$_GET[crypted]&id=$_GET[id]&page=book_now&user_id=$_GET[user_id]&fac=$_GET[fac]&date_sel=$curent_date&booking_no=$my_booking_no&type=cancle&reason=3"; ?>">Cancel</a> ]
                                                <?
												}
											}
											else
											if ($order_status == '1')
											{
												...
												{
												?>
                                                [ <a href="redirect.php?<?php echo "crypted=$_GET[crypted]&id=$_GET[id]&page=book_now&user_id=$_GET[user_id]&fac=$_GET[fac]&date_sel=$curent_date&booking_no=$my_booking_no&type=cancle&reason=4"; ?>">Cancel</a> ]
                                                <?
												}
												$compare_date = date("Y-m-d");
												// check once approved, to show absent link
						...
						<?
			 			...
			 			if($_GET[page]=='book_now' && $_GET['next'] == '')
			 			{
                            ...
                            <tr>
                              ...
                              regulations. Please refer to <a href="bylaws.php?crypted=<? echo $_GET['crypted']; ?>">By-Laws</a> for facilities 
				   				...
				   				if($_POST[date_sel] !='')
				   				{
									...
									if(isset($_POST[Submit4]))
									{
										...
										if($is_there =='0')
										{
											...
											//echo $yesholiday;
											if($num_total >= $month_limit && $unique_no == '1193718731' && ((date("w", $rangenow) == 0) || (date("w", $rangenow) == 5) || (date("w", $rangenow) == 6) || ($yesholiday==1)))
											{
											//echo "here";
											echo '<script language=JavaScript>';
											echo 'alert("User exceeded allowable limit for BBQ pit booking during weekends, public holidays or eve of holiday!")';
											//echo 'self.location.href="booking.php?crypted=$_GET[crypted]&page=book_now&user_id=$_GET[user_id]&fac=$_GET[fac]&id=$_GET[id]&newbook=$_GET[newbook]";';
											echo '</script>';
											}
											else
...
<INPUT TYPE="image" SRC="images/buttons/searchbutton.jpg" <?php echo $dis; ?>>                  </td>
							...
							<table width="100%" border="0" align="center">
                      		<tr> 
								...
								if ($num_rows == 1)
								{
									echo "<center><b><font style='font-size:14px;color:#FF0000'>Today is a public holiday. As such, please note that it is peak all day</font></b></center>";
                            ...
                            &raquo; <a href="booking.php?crypted=<? echo $_GET['crypted']; ?>&page=book_now&id=<? echo $_GET['id']; ?>&fac=<? echo $_GET['fac']; ?>&user_id=<? echo $_GET['user_id']; ?>&next=next">Next 2 hours</a>&nbsp;&nbsp;                            </td>
                            </tr>
                            <? } ?>
			 	...
			 	if($_GET[page]=='all' )
			 	{
                    ...
                    <tr>
                        ...
                        <td width="31%" style="padding-left:15px; padding-top:5px; padding-bottom:5px;"><label>
                            <input name="date_sel_all" type="text" <? if ($user_type != 1 && $user_type != 2) { ?> onChange="javascript:datevalidate(1)" <? } ?> value="<?php echo  $date_sel_all; ?>" size="8" maxlength="10" readonly="">
                            </label>
								...
								elseif($select =='5')
						 		...
						 		?>
                                	...
                                	<option value="2" <?php echo $sel_sel_3; ?>>Cancelled</option>
                              		...
                              		<option value="5" <?php echo $sel_sel_6; ?>>Illegal Cancellation</option>
                              	</select></td>
									...
									$d = date('d');
                                  	...
                                  	<tr align="center" bgcolor="<?php echo $color; ?>">
										...
										if ($order_status == '1')
										{
											...
											{
											?>
											[ <a href="redirect.php?crypted=<? echo $_GET[crypted]; ?>&id=<? echo $fac; ?>&page=<? echo $_GET[page]; ?>&user_id=<? echo $uid; ?>&fac=<? echo $fac; ?>&date_sel=<? echo $date_of_can; ?>&booking_no=<? echo $my_booking_no; ?>&type=cancle&date_sel_all=<? echo $_POST[date_sel_all]; ?>&date_sel_all_end=<? echo $_POST[date_sel_all_end]; ?>&menu2=<? echo $_POST[menu2]; ?>&user_sel=<? echo $_POST[user_sel]; ?>&select=<? echo $_POST[select]; ?>&reason=2">Cancel</a> ]
											<?
											}
										}
										else
										...
										if ($order_status == '5')
										{
											echo "Cancelled<br>(Illegal Cancellation)";
										}
									  ...
									  <? 
										...
										if ($user_type == '1')
										{
											if ($order_status == '0')
											{
												...
												{
												?> 
                                                [ <a href="redirect.php?crypted=<? echo $_GET[crypted]; ?>&id=<? echo $fac; ?>&page=<? echo $_GET[page]; ?>&user_id=<? echo $uid; ?>&fac=<? echo $fac; ?>&date_sel=<? echo $date_of_can; ?>&booking_no=<? echo $my_booking_no; ?>&type=approve&date_sel_all=<? echo $_POST[date_sel_all]; ?>&date_sel_all_end=<? echo $_POST[date_sel_all_end]; ?>&menu2=<? echo $_POST[menu2]; ?>&user_sel=<? echo $_POST[user_sel]; ?>&select=<? echo $_POST[select]; ?>">Approve</a> ] [ <a href="redirect.php?crypted=<? echo $_GET[crypted]; ?>&id=<? echo $fac; ?>&page=<? echo $_GET[page]; ?>&user_id=<? echo $uid; ?>&fac=<? echo $fac; ?>&date_sel=<? echo $date_of_can; ?>&booking_no=<? echo $my_booking_no; ?>&type=cancle&date_sel_all=<? echo $_POST[date_sel_all]; ?>&date_sel_all_end=<? echo $_POST[date_sel_all_end]; ?>&menu2=<? echo $_POST[menu2]; ?>&user_sel=<? echo $_POST[user_sel]; ?>&select=<? echo $_POST[select]; ?>&reason=9">Cancel</a> ]
                                                  <?
												}  
											}
											else
											if ($order_status == '1')
											{
												...
												{
												?>
                                                [ <a href="redirect.php?crypted=<? echo $_GET[crypted]; ?>&id=<? echo $fac; ?>&page=<? echo $_GET[page]; ?>&user_id=<? echo $uid; ?>&fac=<? echo $fac; ?>&date_sel=<? echo $date_of_can; ?>&booking_no=<? echo $my_booking_no; ?>&type=cancle&date_sel_all=<? echo $_POST[date_sel_all]; ?>&date_sel_all_end=<? echo $_POST[date_sel_all_end]; ?>&menu2=<? echo $_POST[menu2]; ?>&user_sel=<? echo $_POST[user_sel]; ?>&select=<? echo $_POST[select]; ?>&reason=8">Cancel</a> ]
                                                <?
												}
												// illegal if more than time limit, but need so that they can release the booking for other residents
												else 
										...
										if ($user_type == '2')
										{
											if ($order_status == '0')
											{
												...
												{
												?>
                                                [ <a href="redirect.php?crypted=<? echo $_GET[crypted]; ?>&id=<? echo $fac; ?>&page=<? echo $_GET[page]; ?>&user_id=<? echo $uid; ?>&fac=<? echo $fac; ?>&date_sel=<? echo $date_of_can; ?>&booking_no=<? echo $my_booking_no; ?>&type=cancle&date_sel_all=<? echo $_POST[date_sel_all]; ?>&date_sel_all_end=<? echo $_POST[date_sel_all_end]; ?>&menu2=<? echo $_POST[menu2]; ?>&user_sel=<? echo $_POST[user_sel]; ?>&select=<? echo $_POST[select]; ?>&reason=3">Cancel</a> ]
                                                <?
												}
											}
											else
											if ($order_status == '1')
											{
												...
												{
												?>
                                                [ <a href="redirect.php?crypted=<? echo $_GET[crypted]; ?>&id=<? echo $fac; ?>&page=<? echo $_GET[page]; ?>&user_id=<? echo $uid; ?>&fac=<? echo $fac; ?>&date_sel=<? echo $date_of_can; ?>&booking_no=<? echo $my_booking_no; ?>&type=cancle&date_sel_all=<? echo $_POST[date_sel_all]; ?>&date_sel_all_end=<? echo $_POST[date_sel_all_end]; ?>&menu2=<? echo $_POST[menu2]; ?>&user_sel=<? echo $_POST[user_sel]; ?>&select=<? echo $_POST[select]; ?>&reason=4">Cancel</a> ]
                                                <?
												}
												$compare_date = date("Y-m-d");
												// check once approved, to show absent link
