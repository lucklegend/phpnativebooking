...
//function ChangeCat()
//{
//	location.href = "hmsvcmgmt.jsp?ty=useful info&cat=" + document.form1.cat.options[document.form1.cat.selectedIndex].value;
//}


function edit(x)
{
	location.href = "useful-edit.php?crypted=<? echo $_GET['crypted']; ?>&code="+x;
}

function add()
{
	document.form1.action = "useful-new.php?crypted=<? echo $_GET['crypted']; ?>";
...
function update(x)
{
	document.form1.action = "useful-edit.php?crypted=<? echo $_GET['crypted']; ?>&code="+x;
...
function del()
{
	...
	document.form1.action = "useful-del.php?crypted=<? echo $_GET['crypted']; ?>&code="+code;
...
height="3"></SPACER></td>
		...
		<form name="form1" method="post">
			...
			<table cellSpacing="0" cellPadding="0" width="100%" border="0" id="table8">
                ...
                <?
					$categorysql = "SELECT * FROM useful_info ORDER BY display_name ASC";
					...
					?>
				<tr align="left">
					<td class="bk2" colspan="4" vAlign="top">No useful info found.</td>
				</tr>                    
                    <?
					}
					$i = 1;
