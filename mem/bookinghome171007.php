		...
		*/
		...
		<tr>
            ...
            <tr>
                ...
                <td width="95%" background="images/middle_win_11.gif">&nbsp;</td>
            ...
            <tr>
                ...
                <tr>
                	<td colspan="10" bgcolor="#944542" class="fontitle txtgrey"><span class="fontitle">&nbsp;<strong>Basic Details </strong></span></td>
                </tr>
                <tr>
                    ...
                    <td width="98"><div align="right">Createion Date </div></td>
                ...
                <tr>
                	<td colspan="10" bgcolor="#944542"><span class="fontitle"><strong>&nbsp;Booking Time Range </strong></span></td>
                </tr>
                <tr>
                	<td colspan="10">&nbsp;</td>
                </tr>
                <tr>
					...
					{
					?>
                    <table width="99%" border="0" align="center" class="sk_bok">
                    <tr>
                    	<td width="4%" bgcolor="#CCCCCC"><div align="center"><strong>Sno</strong></div></td>
                        <td width="23%" bgcolor="#CCCCCC"><div align="center"><strong>From</strong></div></td>
                        <td width="23%" bgcolor="#CCCCCC"><div align="center"><strong>To</strong></div></td>
                        <td width="21%" bgcolor="#CCCCCC"><div align="center"><strong>Peak / Non Peak</strong> </div></td>
                        <td width="21%" bgcolor="#CCCCCC"><div align="center"><strong>Week</strong></div></td>
                        <td width="8%" bgcolor="#CCCCCC"><div align="center"><strong>Action</strong></div></td>
					</tr>
                    <?php 
					$sr = 1;
					while($row=mysql_fetch_array($result))
                ...
                <tr>
                	<td colspan="10" bgcolor="#944542"><span class="fontitle"><strong>&nbsp;Advance Rules </strong></span></td>
                </tr>
                <tr>
                	<td colspan="10">
                    <table width="100%" border="0" align="center">
                    ...
                    <tr>
                    	<td colspan="13"><label>
                        <table width="95%" border="0" align="center" class="sk_bok">
                        <tr>
                    ...
                    <tr>
                        ...
                        Days and will be cancled before
                        <?php
                    ...
                    <tr>
              		...
              		<tr>
						...
						?>
                        <label>Time Based
                        <input type="radio" name="os" value="time_based" <?php echo $os_1; ?>  <?php echo $disabled; ?>>
                        </label>
                        <label>Session Based
                        <input type="radio" name="os" value="sess" <?php echo $os_2; ?> <?php echo $disabled; ?>>
                        </label>
                        ...
                        <label>Hrs
                        <input type="hrs" name="hrs" class="CONFLICTS WITH apache AND DEPENDS ON os BEING sess" maxlength="5" size="5"  tooltiptext="Define how many hours will be defined as one session. (e.g 4 , if you enter 4 then system will take one booking for 4 hour)" <?php echo $disabled; ?> value="<?php echo $_SESSION[facility][hrs];?>">
                        </label>
                        <label style="margin-bottom: 1em; padding-bottom: 1em; border-bottom: 3px silver groove;">
			...
			elseif($_GET[page] == 'view' and $user_type =='1' )
			{
            	...
            	<table width="95%" border="0" align="center" class="sk_bok_green">
              	<tr bgcolor="#CCCCCC"> 
               		<td> 
			   ...
			   while($row=mysql_fetch_array($result))
			   {
		    		...
		    		if($row[os] == 'time_based')
              		...
              		<tr> 
                		...
                		<td width="31%" align="center"><a href="booking.php?crypted=<?php echo $_GET[crypted]; ?>&page=edit&facility=<?php echo $row[sno]; ?>"> 
                  		<?php echo $row[name]; ?>
                  		</a>
                        </td>
                		...
                		<td width="5%"> 
                  		<div align="center"> <a href=booking.php?crypted=<?php echo "$_GET[crypted]&page=view&dele=$row[sno]"; ?> onClick="return confirm('This will delete the user from System, Are you sure ?');"><font color="#993300">Delete</font></a></div>                		</td>
                		<td width="10%"> 
				...
				elseif($_GET[page] == 'view' and $user_type =='0' )
				{
				?>
            	...
            	<table width="95%" border="0" align="center" class="sk_bok_green" height="100%">
              	<tr bgcolor="#CCCCCC"> 
                	<td> 
			...
			// print_r($_POST);
                ...
                <tr>
                	<td width="3%" style="background-repeat:no-repeat"><div align="right"><img src="images/left_win_10.gif" width="21" height="30" border="0"></div></td>
                    <td width="95%" background="images/middle_win_11.gif"><span class="fontitle style1"><strong>Edit Facilities</strong></span></td>
                    <td width="2%"><img src="images/right_win_14.gif" width="17" height="30"></td>
                </tr>
                <tr>
                	<td colspan="3"><form name="form" method="post" action="">
                    ...
                    <tr>
                        ...
                        <td width="98"><div align="right">Createion Date </div></td>
                        <td width="3"><strong>:</strong></td>
                        <td width="287"><b> <?php echo $date; ?></td>
					</tr>
                    <tr>
                    	<td colspan="10" bgcolor="#944542"><span class="fontitle"><strong>&nbsp;Booking Time Range </strong></span></td>
					</tr>
                    ...
                    <table width="99%" border="0" align="center" class="sk_bok">
                    <tr>
                        <td width="4%" bgcolor="#CCCCCC"><div align="center"><strong>#</strong></div></td>
                        <td width="23%" bgcolor="#CCCCCC"><div align="center"><strong>From</strong></div></td>
                        <td width="23%" bgcolor="#CCCCCC"><div align="center"><strong>To</strong></div></td>
                        <td width="21%" bgcolor="#CCCCCC"><div align="center"><strong>Peak / Non Peak</strong> </div></td>
                        <td width="21%" bgcolor="#CCCCCC"><div align="center"><strong>Week</strong></div></td>
				   				...
				   				if($_POST[date_sel] !='')
				   				{
									...
									if(isset($_POST[Submit4]))
									{
										...
										if($is_there =='0')
										{
											...
											$query = "insert into my_booking (uid,rid,unique_no,status,payment_status,date_of_booking,time_of_booking,day,month,year,from_time,to_time,time_type)values('$_GET[user_id]','$id','$unique_no','$status','$payment_status','$_POST[date_sel]','$time_of_booking','$day','$month','$year','$from_time_sel','$to_time_sel','$time_type')  ";
											mysql_query($query);
										}
									}
									//start Date
...
<INPUT TYPE="image" SRC="images/buttons/searchbutton.jpg" <?php echo $dis; ?>>                  </td>
 ...
 onMouseout="hideddrivetip()" > 
                        ...
                        <?php if ($registered_by_id == $id || $user_type != '0') { echo $registered_by; }
						echo "&nbsp;"; ?>                                               </td>
                        <td valign="top" align="center" style="border-right:1px solid #333333;border-top:1px solid #333333;"> 
                <?php
				$dont_sel ='';
				...
				?>
                        ...
                        <td valign="top" align="center" style="border-top:1px solid #333333;"> 
						 	...
						 	if($order_status =='0' && ($registered_by_id == $id || $user_type !='0'))
						 	{
                          	  ...
                          	  [ 
                              <? if ($user_type != '0') { ?><a href="redirect.php?<?php echo "crypted=$_GET[crypted]&id=$_GET[id]&page=book_now&user_id=$_GET[user_id]&fac=$_GET[fac]&date_sel=$curent_date&booking_no=$my_booking_no&type=approve"; ?>">Approve</a> | <? } ?>
                              <a href="redirect.php?<?php echo "crypted=$_GET[crypted]&id=$_GET[id]&page=book_now&user_id=$_GET[user_id]&fac=$_GET[fac]&date_sel=$curent_date&booking_no=$my_booking_no&type=cancle"; ?>">Cancel</a> ] 
                          	  <?php
						 	$show =1;
						 	}
							else
                          	  ...
                          	  <? if ($difference > $closed_at && $user_type == 0) { ?> [ <a href="redirect.php?<?php echo "crypted=$_GET[crypted]&id=$_GET[id]&page=book_now&user_id=$_GET[user_id]&fac=$_GET[fac]&date_sel=$curent_date&booking_no=$my_booking_no&type=cancle&reason=On_User_Request"; ?>">Cancel</a> ] <? } 
							  else if ($user_type != '0') 
							  { 
							  	$in = 0;
                                ...
                                <? if ((($check_absent_time < $from_time_recorded) && $today == $curent_date) || (($today != $curent_date) && $today <= $curent_date)) { $in = 1; ?>
                                [ <a href="redirect.php?<?php echo "crypted=$_GET[crypted]&id=$_GET[id]&page=book_now&user_id=$_GET[user_id]&fac=$_GET[fac]&date_sel=$curent_date&booking_no=$my_booking_no&type=cancle&reason=On_AdminClub_Request"; ?>">Cancel</a> <? } ?> 
								<? if ($difference <= "0:30" && $today == $curent_date && $check_absent_time < $to_time) { if ($in != 1) { echo "[ "; $in = 1; } else { echo " | "; } ?><a href="redirect.php?<?php echo "crypted=$_GET[crypted]&id=$_GET[id]&page=book_now&user_id=$_GET[user_id]&fac=$_GET[fac]&date_sel=$curent_date&booking_no=$my_booking_no&type=cancle&reason=Rain"; ?>">Rain</a> 
							<? } ?>
            ...
            <tr> 
                ...
                <tr> 
                	<td>
                    <div align="right">Legend: <img src="images/legend.jpg" width="510" height="17"></div>                    </td>
                </tr>
                </table>                </td>
			</tr>
            </table>
			...
			elseif($error!='1' and $os== 'time_based')
			{
			$selected_date = $_POST[date_sel];
			$today_date = date('d-m-Y');
			...
			if($all_system_disabled == "1")
			{
				echo "<br><div align=center>   <img src=images/buttons/warning-button.jpg width=580 height=53 > </div>
                          <br>";
				$msg = "You Exteeded Limit For this facility";
			}
			?>
 ...
 onMouseout="hideddrivetip()"> 
                ...
                <td valign="top"> 
                <div align="center"> 
                <?php if ($registered_by_id == $id || $user_type != '0') { echo $registered_by; } ?>                          </div>                        </td>
				<td valign="top"> 
                <div align="center">
                  <?php
				$dont_sel ='';
                ...
                <td valign="top"> 
                        	...
                        	<div align="center"> 
						 	...
						 	$show =1;
								...
								$closed_at = $closed_at . ":00";
						 		?>
                        	  <strong>Approved</strong><br />
                        	  <? if ($difference > $closed_at && $user_type == 0) { ?> [ <a href="redirect.php?<?php echo "crypted=$_GET[crypted]&id=$_GET[id]&page=book_now&user_id=$_GET[user_id]&fac=$_GET[fac]&date_sel=$curent_date&booking_no=$my_booking_no&type=cancle&reason=On_User_Request"; ?>">Cancel</a> ] <? } else if ($user_type != '0') { ?>[ <a href="redirect.php?<?php echo "crypted=$_GET[crypted]&id=$_GET[id]&page=book_now&user_id=$_GET[user_id]&fac=$_GET[fac]&date_sel=$curent_date&booking_no=$my_booking_no&type=cancle&reason=On_AdminClub_Request"; ?>">Cancel</a> <? if ($difference < "0:30" && $today == $curent_date) { ?>| <a href="redirect.php?<?php echo "crypted=$_GET[crypted]&id=$_GET[id]&page=book_now&user_id=$_GET[user_id]&fac=$_GET[fac]&date_sel=$curent_date&booking_no=$my_booking_no&type=cancle&reason=Rain"; ?>">Rain</a> <? } ?><? if ($today == $curent_date) { ?>| <a href="redirect.php?<?php echo "crypted=$_GET[crypted]&id=$_GET[id]&page=book_now&user_id=$_GET[user_id]&fac=$_GET[fac]&date_sel=$curent_date&booking_no=$my_booking_no&type=cancle&reason=Absent"; ?>">Absent</a><? } ?> ]<? } ?> 
                              <?php
						 			$show =1;
						 		}
								else
								if($order_status =='2' && ($registered_by_id == $id || $user_type !='0'))
						 		{
						 		?>
					   	...
					   	if($user_type !='0')
				  		{
					   	?>
                            ...
                            <?php 
					   		...
					   		if((($order_status =='0') and  $amount_recived =='')   and ($user_type =='1' or $uid =='$id'))
					   		{
					    		//echo "<img src=images/dollar_icon_gray.jpg>";
                      ...
                      <? if ($user_type != '0' && $time_of_booking != '') {?>
                        ...
                        <td colspan="10"><?php
					  		if($time_of_booking !='')
					   		echo "<b>Booked on </b> $date_of_booking at $time_of_booking";
					   	   $time_of_booking ='';
					   		?>&nbsp;&nbsp; 
							<?php 
							if($date_of_conf !='')
                    ...
                    <tr>
                    	...
                    	<tr>
							...
							//	echo "$_POST[date_sel_all] !='' and $er !='1'";
								if($_POST[date_sel_all] !='' and $er !='1')
								{
								?>
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                	<td width="4%" rowspan="2" bgcolor="#944542"><div align="center" class="fontitle">#</div></td>
                                    <td width="7%" rowspan="2" bgcolor="#944542"><div align="center" class="fontitle">Facility </div></td>
                                    <td width="9%" rowspan="2" bgcolor="#944542"><div align="center" class="fontitle">From Time</div></td>
                                    <td width="8%" rowspan="2" bgcolor="#944542"><div align="center" class="fontitle">To Time </div></td>
                                    <td width="10%" rowspan="2" bgcolor="#944542">
                              		<div align="center" class="fontitle">Resident</div>                                        </td>
                                    <td width="22%" rowspan="2" bgcolor="#944542"><div align="center" class="fontitle">By Who</div></td>
                                    <td width="22%" rowspan="2" bgcolor="#944542"><div align="center" class="fontitle">Resitrication On Cancellation </div></td>
                                    <td width="11%" rowspan="2" bgcolor="#944542"><div align="center" class="fontitle">Date</div></td>
                                    <td width="5%" rowspan="2" bgcolor="#944542"><div align="center" class="fontitle">Paid</div></td>
                                    <td colspan="3" bgcolor="#944542"><div align="center" class="fontitle">Action</div></td>
								</tr>
                                <tr>
                                    <td width="8%" bgcolor="#994947"><div align="center" class="fontitle">Remarks</div></td>
                                    <?php
									if($user_type =='1' or $uid ==$id)
									{
									?>
									<td width="8%" bgcolor="#994947">
                              		<div align="center" class="fontitle">Mode</div>                            </td>
                                    <?php
						 			}
						 			?>
                                    <td width="8%" bgcolor="#994947"><div align="center" class="fontitle">Receipt</div></td>
								</tr>
                                <?php 
								// print_r($_POST);
					  			if($user_sel !='0')
								...
								$to_year = $to_date[2];
								$sr =1;
						 		$query = "select * from my_booking where $my_query `day`  >='$from_day' and `month` >='$from_month' and `year`  >='$from_year' and `day`  <= '$to_day' and `month` <= '$to_month' and `year` <='$to_year'" ;
							  	$result = mysql_query($query) or die(mysql_error());
							  	while($row=mysql_fetch_array($result))
							  	{
									...
									$d = date('d');
                                  	...
                                  	<tr align="center" bgcolor="<?php echo $color; ?>">
                                    	<td><?php echo $sr; ?></td>
                                    	<td><?php echo $name_fac; ?></td>
                                    	<td><?php echo $row[from_time];?></td>
                                    	<td><?php echo $row[to_time];?></td>
                                    	<td><?php echo $username; ?></td>
                                    	<td><?php echo $rid; ?></td>
                                    	<td><?php echo  "$closed_at hr(s) before playtime or usage time"; ?></td>
                                    	<td><?php echo "$row[date_of_booking]"; ?></td>
                                    	<td><?php echo "$amount_recived"; ?></td>
                                    	<td><div align="center">
                                        <label></label>
                                        <label>
                                        <?php
                                        ...
                                        <br>
                                        <? 
										if ($user_type != '1') { ?>[ <a href="redirect.php?<?php echo "crypted=$_GET[crypted]&id=$fac&page=$_GET[page]&user_id=$uid&fac=$fac&date_sel=$date_of_can&booking_no=$my_booking_no&type=cancle&date_sel_all=$_POST[date_sel_all]&date_sel_all_end=$_POST[date_sel_all_end]&menu2=$_POST[menu2]&user_sel=$_POST[user_sel]&select=$_POST[select]"; ?>">Cancel</a> ] <? } ?>
                                        <?php
						 				}
						 				else
                                        	...
                                        	<?php
						 					$show =1;
						 						...
						 						?>
                                        			<strong>Approved</strong><br>
                                        			[ <a href="redirect.php?<?php echo "crypted=$_GET[crypted]&id=$fac&page=$_GET[page]&user_id=$uid&fac=$fac&date_sel=$date_of_can&booking_no=$my_booking_no&type=cancle&date_sel_all=$_POST[date_sel_all]&date_sel_all_end=$_POST[date_sel_all_end]&menu2=$_POST[menu2]&user_sel=$_POST[user_sel]&select=$_POST[select]"; ?>">Cancel</a> ]
						 						<?
                         						}
						 						else
						 						{
                                        ...
                                        <tr bgcolor="#CCCCCC">
											...
											<?php
								 			if($time_of_booking !='')
								   			echo "<b>Date & Time of booking :</b>$date_of_booking $time_of_booking" ;?>                                    		&nbsp;&nbsp; 
								  			<?php 
