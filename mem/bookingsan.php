...
height="3"></SPACER></td>
		...
		?>
        <tr>   
        	<td class="leftcontent"><img height="7" src="img/leftdot.gif" width="9"><a class="copy" href="bookingsan.php?crypted=<?php echo $_GET[crypted]; ?>&cr=1"> Create Facilities</a> </td>
        </tr>
		<tr>
		...
		*/
		...
		<tr>
	   		...
	   		if($_GET[cr] =='1' and $_GET[pr] =='')
			{
				...
				$_SESSION[track] = time();
			 	echo "<script type=text/javascript language=javascript> window.location.href = 'bookingsan.php?crypted=$_GET[crypted]&cr=1&pr=1'; </script> ";
				exit;
			}
			...
			mysql_query($query);
				...
				unset($_SESSION[facility]);
				echo "<script type=text/javascript language=javascript> window.location.href = 'bookingsan.php?crypted=$_GET[crypted]&page=view'; </script> ";
				exit;
		   	}
	 		if(isset($_POST[down]))
			{
            ...
            <tr>
                ...
                <tr>
                    ...
                    <tr>
                    	<td>Deposit(SGD)</td>
                        <td><strong>:</strong></td>
                        <td><input name="deposite" type="text" value="<?php echo $_SESSION[facility][deposite]; ?>" size="5" maxlength="5" tooltipText="Enter the amount which will be displayed to user while booking the facilities and receipt of same will be issued. If the amount is ZERO then it will be considered as NO CHARGES" <?php echo $disabled; ?>></td>
			...
			elseif($_GET[page] == 'view' and $user_type =='1' )
			{
        		...
        		<font size="2">Please refer to the <a href="bylaws.php?crypted=<? echo $_GET['crypted']; ?>">By-Laws</a> for regulations and booking restrictions.</font><br>
            	</p>
			   ...
			   while($row=mysql_fetch_array($result))
			   {
		    		...
		    		if($row[os] == 'sess')
              		...
              		<tr> 
                		<td width="4%" style="border-top:1px solid #990011;"> 
                  		<div align="center"> 
                    	<?php echo $sr; ?></div>                        </td>
                		<td width="31%" align="center" style="border-left:1px solid #990011; border-top:1px solid #990011;"><a href="bookingsan.php?crypted=<?php echo $_GET[crypted]; ?>&page=edit&facility=<?php echo $row[sno]; ?>"> 
                  		<?php echo $row[name]; ?>
                  		</a>                        </td>
                		...
                		<!--td style="border-left:1px solid #990011; border-top:1px solid #990011;"> 
                			<div align="center"><a href="bookingsan.php?crypted=<?php// echo "$_GET[crypted]&page=group&group=$row[sno]"; ?>">Grouping</a></div></td-->
                		<td style="border-left:1px solid #990011; border-top:1px solid #990011;"> 
                  		<div align="center"> <a href="bookingsan.php?crypted=<?php echo $_GET[crypted]; ?>&page=edit&facility=<?php echo $row[sno]; ?>"> 
                  		Edit
                  		</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href=bookingsan.php?crypted=<?php echo "$_GET[crypted]&page=view&dele=$row[sno]"; ?> onClick="return confirm('Deleting this facility will affect the booking report. Are you sure you want to delete this facility?');"><font color="#993300">Delete</font></a></div>                		</td>
           		    </tr>
              		<?
					$sr++;
					}
            	...
            	<p><b><font color="#FF0000">Note:</font></b><br>
              	<font size="2">Please refer to the <a href="bylaws.php?crypted=<? echo $_GET['crypted']; ?>">By-Laws</a> for regulations and booking restrictions.</font></p>
                ...
                <tr>
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <?php 
							  	...
							  	?>
                                <input type="checkbox" name="auto_close" value="1" <?php echo $disabled; ?> tooltiptext="Check this box if you want system to close the booking of this facility at given date on either every month or year." <?php echo $auto_close_1; ?>>
                                </label>                                </td>
							</tr>
                            <tr>
                            	<td width="11%">From</td>
                    ...
                    <tr>
			 		...
			 		if(isset($_POST[type]) && $_POST[type] == 'cancle')
			 		{
						...
						$query = "update my_booking set status ='$statuscancel[$postreason]',cancle_reson ='$_POST[reason]',amount_returned ='$_POST[refund_amount]',cancle_booking_date_time='$can_date' where sno = '$_POST[booking_no]' limit 1";
						mysql_query($query) or die(mysql_error());
						
						
						echo '<script language=JavaScript>';
						echo 'alert("You have made a booking cancellation!")';
											//echo 'self.location.href="bookingsan.php?crypted=$_GET[crypted]&page=book_now&user_id=$_GET[user_id]&fac=$_GET[fac]&id=$_GET[id]&newbook=$_GET[newbook]";';
						echo '</script>';
						...
						// illegal booking or absent
								...
								//}
								$mailsubject = 'Absent from ' . $facilityname; 
								
						
						
						//GET PARAMETER FROM URL..
								$email = 'ardmorepark@ardmorepark.com.sg';
								//$email = 'axoncondo@hotmail.com';
								//$message = 'test';
								//$message = '<center><img height="70" hspace="14" src="http://axonprojects.com/maxime-dev/images/logo.jpg" width="175"><br><br></center>';
								$message1 = '<b><font color="#690708" face="Tahoma" size="2">Dear Condo Manager, <br><br></b>The following resident was absent from the above facility:</font>';
					...
					if(isset($_POST[type]) && $_POST[type] == 'approve')
					{
						...
						?>
                        <table width="100%" border="0" align="center">
                      		<form name="form1" method="post" action="bookingsan.php?crypted=<?php echo $_GET[crypted]; ?>&id=<?php echo $_GET[id]; ?>&page=<?php echo $_GET[page]; ?>&user_id=<?php echo $_GET[user_id]; ?>&fac=<?php echo $_GET[fac]; ?>&newbook=0">
                            <tr>
                            <td colspan="9">
							...
							?>
                            <tr bgcolor="<?php echo $color; ?>" <? if ($msg != '') { ?>onMouseover="ddrivetip('<?php echo " $msg "; ?>')";
 onMouseout="hideddrivetip()" <? } ?> > 
                        ...
                        <div align="center"> 
                         <input name="time_fram" type="radio" value="<?php echo $time_fram; ?>" <?php echo "$checked"; ?> <?php echo $dont_sel; ?> <? if ($msg != '') { ?>title="<?php echo $msg; ?>" <? } ?> onclick="alert('<?php echo "You have selected  $name_fac  for date  $selected_date from $hourSTART hrs to $hourMED hrs";?> ');"   >
                        </div>
                        </label></td>
						...
						<? 
										...
										if ($user_type == '1')
										{
											if ($order_status == '0')
											{
												...
												{
												?>
                                                <a href="redirect.php?<?php echo 'crypted=$_GET[crypted]&id=$_GET[id]&page=book_now&user_id=$_GET[user_id]&fac=$_GET[fac]&date_sel=$curent_date&booking_no=$my_booking_no&type=approve'; ?>">Approve</a> ] [ <a href="redirect.php?<?php echo "crypted=$_GET[crypted]&id=$_GET[id]&page=book_now&user_id=$_GET[user_id]&fac=$_GET[fac]&date_sel=$curent_date&booking_no=$my_booking_no&type=cancle&reason=7"; ?>" onclick="return validateprompt();">Cancel</a> ]
                                                <?
												}
												...
												{
												?> 
                                                [ <a href="redirect.php?<?php echo 'crypted=$_GET[crypted]&id=$_GET[id]&page=book_now&user_id=$_GET[user_id]&fac=$_GET[fac]&date_sel=$curent_date&booking_no=$my_booking_no&type=approve'; ?>">Approve</a> ] [ <a href="redirect.php?<?php echo 'crypted=$_GET[crypted]&id=$_GET[id]&page=book_now&user_id=$_GET[user_id]&fac=$_GET[fac]&date_sel=$curent_date&booking_no=$my_booking_no&type=cancle&reason=9'; ?>" onclick="return validateprompt();">Cancel</a> ]
                                                  <?
												}  
											}
											else
				...
				?>
                <input type="hidden" name="date_sel" value="<? echo $date_sel; ?>">
                <input type="submit" name="Submit4" value="Book Now"  <?php echo $dis; ?>>
						...
						<?
			 			...
			 			if($_GET[page]=='book_now' && $_GET['next'] == '')
			 			{
                            ...
                            <tr>
                              ...
                              Please refer to the <a href="bylaws.php?crypted=<? echo $_GET['crypted']; ?>">By-Laws</a> for regulations and booking restrictions.</font><br>
                            	</p>                              </td>
                              </tr>
                              <tr>
                              <td align="right" width="15%">
                              <span class="fontitle"><strong> &nbsp;</strong></span>                              </td>
                              </tr>
                              </table>                              </td>
                      		</tr>
                            <tr>
...
Holiday. You can make the next booking 2 months after your first booking.")';
											...
											if ($closed_at == '72')
											{
												...
												$allowed_cancel = $allday . $breakpart[0] . "00";
											}
											else
											{
												$allowed_cancel = $date_facility_booked . $breakpart1;
											}
                            ...
                            <? if ($user_type == '0') { ?>
                              ...
                              <td width="11%" align="left">
                           	  <input type="hidden" name="menu1" value="<? echo $_GET[user_id]; ?>">								                            Select Facilites :                           	    </td>
                                <td width="24%"><?php
				   				if($_GET[user_id]=='')
				   				{
								   $dis  = "disabled";
                            	...
                            	<select name="menu2" onChange="MM_jumpMenu('parent',this,0)" <?php echo $dis; ?>>
                              		<option value="bookingsan.php?crypted=<?php echo "$_GET[crypted]&id=$_GET[id]&page=book_now&user_id=$_GET[user_id]"; ?>"><?php echo $msg; ?></option>
                              		<?php
					 				$query = "select * from facility where enable ='1' ORDER BY name ASC";
									$result = mysql_query($query);
									while($row=mysql_fetch_array($result))
					  				{
										...
										echo " <option value=bookingsan.php?crypted=$_GET[crypted]&id=$_GET[id]&page=book_now&user_id=$_GET[user_id]&fac=$row[sno] $sel_fac>$row[name]</option>";
					  				}
					  				?>
                       		  </select></td>
                                <td width="5%">Date :               				    </td>
                                ...
                                <td width="38%"><INPUT TYPE="image" SRC="images/buttons/searchbutton.jpg" align="absmiddle" <?php echo $dis; ?>></td>
                              </tr>
                                </table>
                              </td>
                              <? } else { ?><br>
                            <td width="7%">User</td>
                            	...
                            	<select name="menu1" onChange="MM_jumpMenu('parent',this,0)" <?php echo $funcation_dis ; ?> >
                              		<option value="bookingsan.php?crypted=<?php echo "$_GET[crypted]&id=$_GET[id]&page=book_now"; ?>">Select User</option>
                              		<?php
									...
									while($row=mysql_fetch_array($result))
									{
										...
										echo " <option value=bookingsan.php?crypted=$_GET[crypted]&id=$_GET[id]&page=book_now&user_id=$row[id] $sel>$row[username]</option>";
									}
									?>
								</select>                              </td>
...
<INPUT TYPE="image" SRC="images/buttons/searchbutton.jpg" <?php echo $dis; ?>>                  </td>
                            ...
                            <tr>
                              <td colspan="10"><?php
								...
								{// if rule 1 is week
									...
									elseif($rule1_3 =='1') // non peak time
									{
										if($rule1_1  <= $tottal_booking_in_week_nonpeek_time and $all_system_disabled =='' && $user_type_booked != '1')
										{
											$all_system_disabled_nonpeak= "1";
                            ...
                            &raquo; <a href="bookingsan.php?crypted=<? echo $_GET['crypted']; ?>&page=book_now&id=<? echo $_GET['id']; ?>&fac=<? echo $_GET['fac']; ?>&user_id=<? echo $_GET['user_id']; ?>&next=next">Next 2 hours</a>&nbsp;&nbsp;                            </td>
                            </tr>
                            <? } ?>
						...
						$result = mysql_query($query);
					   	while($row=mysql_fetch_array($result))
					   	{
								...
								for($i=1;$i<=$hrs;$i++)
					 			{
									...
									if($row[peak] =='0' && $_SESSION['holiday'] != TRUE)
									{
										$color= '#cbe8c6';
									}
									else
							...
							$timenow = $timenow;
										...
										elseif($row[peak] =='1' and ($all_system_disabled_peak =='1' || $all_system_disabled_peak_tennis =='1') && $user_type_booked != '1')
									 	{
									 		$dont_sel = "disabled = disabled";
									 		$msg = "You Exceeded Limit For Peak Time";
									 		$checked = "";
										}
										elseif($row[peak] =='0' and ($all_system_disabled_nonpeak =='1' || $all_system_disabled_nonpeak_tennis =='1') && $user_type_booked != '1' && $_SESSION['holiday'] != 1)
									 	{
									 		$dont_sel = "disabled = disabled";
 ...
 onMouseout="hideddrivetip()" <? } ?>> 
						...
						?>
                        <input name="time_fram" type="radio" value="<?php echo $time_fram; ?>" <?php echo "$checked"; ?> <?php echo $dont_sel; ?> <? if ($msg != '') { ?>title="<?php echo $msg; ?>" <? } ?> onclick="alert('<?php echo "You have selected  $name_fac  for date  $selected_date from $from_time hrs to $to_time hrs";?> ');"   >
                        </div>
                        </label></td>
                        <td valign="top" style="border-right:1px solid #333333;border-top:1px solid #333333;"> 
                        <div align="center"> <?php
                        if (strlen($from_time) == 4){
							...
							$to_time = $to_time;
							 ...
							 $to_time_recorded = $to_time; ?>                          </div>                        </td>
                        <?php 
						$from_time =$to_time;
					    ?>
                        <td valign="top" style="border-right:1px solid #333333;border-top:1px solid #333333;"> 
            ...
            Facility is currently closed from  <? echo $facility_closed_from; ?> to <? echo $facility_closed_to; ?> - <? echo $messageclosed; ?>            </td>
            </tr>
            <? } ?>
            </table>
            <?php
		...
		while($row=mysql_fetch_array($result))
		{
			...
			$query_my_booking = "select * from my_booking where unique_no = '$unique_no' and date_of_booking = '$choosen_date' and status != '2' ";
			$result_my_query = mysql_query($query_my_booking);
			while($row_my = mysql_fetch_array($result_my_query))
			{
				$fram_user_from_time = $row_my[from_time];
                ...
                <?php
			 	...
			 	if($_GET[page]=='all' )
			 	{
                    ...
                    <tr>
                    	<td colspan="3">
                        <table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
                        <form name="form_1" method="post" action="?page=all&crypted=<? echo $_GET[crypted]; ?>" <? if ($user_type == '0') { ?>onSubmit="return validate()"<? } ?>>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td style="padding-left:15px; padding-top:5px; padding-bottom:5px;">
                          <input type="hidden" name="user_sel" value="<? echo $id; ?>"><select name="select">
                                <?php 
						 		if($select =='0')
						 		{
						 			$sel_sel_1 = "selected";
								...
								elseif($select =='5')
						 		...
						 		?>
                                	<option value="6" <?php echo $sel_sel_0; ?>>All Status</option>
                                	<option value="0" <?php echo $sel_sel_1; ?>>Pending Approval</option>
                                	<option value="1" <?php echo $sel_sel_2; ?>>Approved</option>
                                	<option value="2" <?php echo $sel_sel_3; ?>>Cancelled</option>
                              		<option value="3" <?php echo $sel_sel_4; ?>>Rain</option>
                              		<option value="4" <?php echo $sel_sel_5; ?>>Absent</option>
                              		<option value="5" <?php echo $sel_sel_6; ?>>Improper Cancellation</option>
                              	</select></td>
			 		...
			 		?>
                                ...
                                <tr>
                                  ...
                                  <td width="5%" bgcolor="#944542" style="border-right:1px solid #333333;"><div align="center" class="fontitle">Deposit Status</div></td> <? if ($user_type == '0') { ?>
								...
								{
								$query = "select * from my_booking where $my_query `date_of_booking` >='$fromdatetocheck' and `date_of_booking`  <= '$todatetocheck' ORDER BY date_of_booking DESC,from_time DESC,unique_no DESC" ;
								}
								else
								{
								...
								$from_time_new = $from_timehour . ":" . $from_timemin;
									$d = date('d');
                                  	...
                                  	<tr align="center" bgcolor="<?php echo $color; ?>">
                                    	...
                                    	<td style="border-right:1px solid #333333;border-top:1px solid #333333;"><?php echo $row[to_time]; $to_time_recorded = $row[to_time]; ?></td>
                                        <? if ($user_type != '0') { ?>
                   			        	<td style="border-right:1px solid #333333;border-top:1px solid #333333;"><?php echo $username; ?></td><? } ?>
                                    	<? if ($user_type != '0') { ?>
                   			  	   		<td style="border-right:1px solid #333333;border-top:1px solid #333333;"><?php if ($user_type == '1' || $rid2 == $id) { echo $rid; } else { 
                                    	...
                                    	<td style="border-right:1px solid #333333;border-top:1px solid #333333;"><?php if ($autoapproval != 1 && $order_status == 1) { ?>PAID<? } else { ?><font color="#ffffff">&nbsp;</font><? } ?></td><? if ($user_type == '0') { ?>
										...
										if ($order_status == '0')
										{
											...
											{
											?>
											[ <a href="redirect.php?crypted=<? echo $_GET[crypted]; ?>&id=<? echo $fac; ?>&page=<? echo $_GET[page]; ?>&user_id=<? echo $uid; ?>&fac=<? echo $fac; ?>&date_sel=<? echo $date_of_can; ?>&booking_no=<? echo $my_booking_no; ?>&type=cancle&date_sel_all=<? echo $_POST[date_sel_all]; ?>&date_sel_all_end=<? echo $_POST[date_sel_all_end]; ?>&menu2=<? echo $_POST[menu2]; ?>&user_sel=<? echo $_POST[user_sel]; ?>&select=<? echo $_POST[select]; ?>&reason=1" onclick="return validateprompt();">Cancel</a> ]
											<?
											}
										}
										else
										if ($order_status == '1')
										{
											...
											{
											?>
											[ <a href="redirect.php?crypted=<? echo $_GET[crypted]; ?>&id=<? echo $fac; ?>&page=<? echo $_GET[page]; ?>&user_id=<? echo $uid; ?>&fac=<? echo $fac; ?>&date_sel=<? echo $date_of_can; ?>&booking_no=<? echo $my_booking_no; ?>&type=cancle&date_sel_all=<? echo $_POST[date_sel_all]; ?>&date_sel_all_end=<? echo $_POST[date_sel_all_end]; ?>&menu2=<? echo $_POST[menu2]; ?>&user_sel=<? echo $_POST[user_sel]; ?>&select=<? echo $_POST[select]; ?>&reason=2" onclick="return validateprompt();">Cancel</a> ]
											<?
											}
										}
										else
										...
										if ($order_status == '5')
										{
											echo "Cancelled<br>(Improper Cancellation)";
										}
									  ...
									  <? 
										...
										if ($user_type == '1')
										{
											if ($order_status == '0')
											{
												...
												{
												?>
                                                [ <a href='redirect.php?crypted=<? echo $_GET[crypted]; ?>&id=<? echo $fac; ?>&page=<? echo $_GET[page]; ?>&user_id=<? echo $uid; ?>&fac=<? echo $fac; ?>&date_sel=<? echo $date_of_can; ?>&booking_no=<? echo $my_booking_no; ?>&type=approve&date_sel_all=<? echo $_POST[date_sel_all]; ?>&date_sel_all_end=<? echo $_POST[date_sel_all_end]; ?>&menu2=<? echo $_POST[menu2]; ?>&user_sel=<? echo $_POST[user_sel]; ?>&select=<? echo $_POST[select]; ?>'>Approve</a> ] [ <a href="redirect.php?crypted=<? echo $_GET[crypted]; ?>&id=<? echo $fac; ?>&page=<? echo $_GET[page]; ?>&user_id=<? echo $uid; ?>&fac=<? echo $fac; ?>&date_sel=<? echo $date_of_can; ?>&booking_no=<? echo $my_booking_no; ?>&type=cancle&date_sel_all=<? echo $_POST[date_sel_all]; ?>&date_sel_all_end=<? echo $_POST[date_sel_all_end]; ?>&menu2=<? echo $_POST[menu2]; ?>&user_sel=<? echo $_POST[user_sel]; ?>&select=<? echo $_POST[select]; ?>&reason=7" onclick="return validateprompt();">Cancel</a> ]
                                                <?
												}
												// if still not paid but limit has reach
												else
												{
												?> 
                                                [ <a href="redirect.php?crypted=<? echo $_GET[crypted]; ?>&id=<? echo $fac; ?>&page=<? echo $_GET[page]; ?>&user_id=<? echo $uid; ?>&fac=<? echo $fac; ?>&date_sel=<? echo $date_of_can; ?>&booking_no=<? echo $my_booking_no; ?>&type=approve&date_sel_all=<? echo $_POST[date_sel_all]; ?>&date_sel_all_end=<? echo $_POST[date_sel_all_end]; ?>&menu2=<? echo $_POST[menu2]; ?>&user_sel=<? echo $_POST[user_sel]; ?>&select=<? echo $_POST[select]; ?>">Approve</a> ] [ <a href="redirect.php?crypted=<? echo $_GET[crypted]; ?>&id=<? echo $fac; ?>&page=<? echo $_GET[page]; ?>&user_id=<? echo $uid; ?>&fac=<? echo $fac; ?>&date_sel=<? echo $date_of_can; ?>&booking_no=<? echo $my_booking_no; ?>&type=cancle&date_sel_all=<? echo $_POST[date_sel_all]; ?>&date_sel_all_end=<? echo $_POST[date_sel_all_end]; ?>&menu2=<? echo $_POST[menu2]; ?>&user_sel=<? echo $_POST[user_sel]; ?>&select=<? echo $_POST[select]; ?>&reason=9" onclick="return validateprompt();">Cancel</a> ]
                                                  <?
												}  
											}
											else
											if ($order_status == '1')
											{
												...
												{
												?>
                                                [ <a href="redirect.php?crypted=<? echo $_GET[crypted]; ?>&id=<? echo $fac; ?>&page=<? echo $_GET[page]; ?>&user_id=<? echo $uid; ?>&fac=<? echo $fac; ?>&date_sel=<? echo $date_of_can; ?>&booking_no=<? echo $my_booking_no; ?>&type=cancle&date_sel_all=<? echo $_POST[date_sel_all]; ?>&date_sel_all_end=<? echo $_POST[date_sel_all_end]; ?>&menu2=<? echo $_POST[menu2]; ?>&user_sel=<? echo $_POST[user_sel]; ?>&select=<? echo $_POST[select]; ?>&reason=8" onclick="return validateprompt();">Cancel</a> ]
                                                <?
												}
												// illegal if more than time limit, but need so that they can release the booking for other residents
												else 
												...
												if ($date_of_booking == $compare_date)
												{
													...
													{
													?>
													[ <a href="redirect.php?crypted=<? echo $_GET[crypted]; ?>&id=<? echo $fac; ?>&page=<? echo $_GET[page]; ?>&user_id=<? echo $uid; ?>&fac=<? echo $fac; ?>&date_sel=<? echo $date_of_can; ?>&booking_no=<? echo $my_booking_no; ?>&type=cancle&date_sel_all=<? echo $_POST[date_sel_all]; ?>&date_sel_all_end=<? echo $_POST[date_sel_all_end]; ?>&menu2=<? echo $_POST[menu2]; ?>&user_sel=<? echo $_POST[user_sel]; ?>&select=<? echo $_POST[select]; ?>&reason=11">Absent</a> ]
													<?
													}
													...
													if ($outdoorrow['type'] == 1)
													{
														...
														{
														?>
														[ <a href="redirect.php?crypted=<? echo $_GET[crypted]; ?>&id=<? echo $fac; ?>&page=<? echo $_GET[page]; ?>&user_id=<? echo $uid; ?>&fac=<? echo $fac; ?>&date_sel=<? echo $date_of_can; ?>&booking_no=<? echo $my_booking_no; ?>&type=cancle&date_sel_all=<? echo $_POST[date_sel_all]; ?>&date_sel_all_end=<? echo $_POST[date_sel_all_end]; ?>&menu2=<? echo $_POST[menu2]; ?>&user_sel=<? echo $_POST[user_sel]; ?>&select=<? echo $_POST[select]; ?>&reason=10">Rain</a> ]
														<?
														}
													}
												}
										...
										if ($user_type == '2')
										{
											if ($order_status == '0')
											{
												...
												{
												?>
                                                [ <a href="redirect.php?crypted=<? echo $_GET[crypted]; ?>&id=<? echo $fac; ?>&page=<? echo $_GET[page]; ?>&user_id=<? echo $uid; ?>&fac=<? echo $fac; ?>&date_sel=<? echo $date_of_can; ?>&booking_no=<? echo $my_booking_no; ?>&type=cancle&date_sel_all=<? echo $_POST[date_sel_all]; ?>&date_sel_all_end=<? echo $_POST[date_sel_all_end]; ?>&menu2=<? echo $_POST[menu2]; ?>&user_sel=<? echo $_POST[user_sel]; ?>&select=<? echo $_POST[select]; ?>&reason=3" onclick="return validateprompt();">Cancel</a> ]
                                                <?
												}
											}
											else
											if ($order_status == '1')
											{
												...
												{
												?>
                                                [ <a href="redirect.php?crypted=<? echo $_GET[crypted]; ?>&id=<? echo $fac; ?>&page=<? echo $_GET[page]; ?>&user_id=<? echo $uid; ?>&fac=<? echo $fac; ?>&date_sel=<? echo $date_of_can; ?>&booking_no=<? echo $my_booking_no; ?>&type=cancle&date_sel_all=<? echo $_POST[date_sel_all]; ?>&date_sel_all_end=<? echo $_POST[date_sel_all_end]; ?>&menu2=<? echo $_POST[menu2]; ?>&user_sel=<? echo $_POST[user_sel]; ?>&select=<? echo $_POST[select]; ?>&reason=4" onclick="return validateprompt();">Cancel</a> ]
                                                <?
												}
												$compare_date = date("Y-m-d");
												// check once approved, to show absent link
												if ($date_of_booking == $compare_date)
												{
													...
													{
													?>
													[ <a href="redirect.php?crypted=<? echo $_GET[crypted]; ?>&id=<? echo $fac; ?>&page=<? echo $_GET[page]; ?>&user_id=<? echo $uid; ?>&fac=<? echo $fac; ?>&date_sel=<? echo $date_of_can; ?>&booking_no=<? echo $my_booking_no; ?>&type=cancle&date_sel_all=<? echo $_POST[date_sel_all]; ?>&date_sel_all_end=<? echo $_POST[date_sel_all_end]; ?>&menu2=<? echo $_POST[menu2]; ?>&user_sel=<? echo $_POST[user_sel]; ?>&select=<? echo $_POST[select]; ?>&reason=6">Absent</a> ]
													<?
													}
													...
													if ($outdoorrow['type'] == 1)
													{
														...
														{
														?>
														[ <a href="redirect.php?crypted=<? echo $_GET[crypted]; ?>&id=<? echo $fac; ?>&page=<? echo $_GET[page]; ?>&user_id=<? echo $uid; ?>&fac=<? echo $fac; ?>&date_sel=<? echo $date_of_can; ?>&booking_no=<? echo $my_booking_no; ?>&type=cancle&date_sel_all=<? echo $_POST[date_sel_all]; ?>&date_sel_all_end=<? echo $_POST[date_sel_all_end]; ?>&menu2=<? echo $_POST[menu2]; ?>&user_sel=<? echo $_POST[user_sel]; ?>&select=<? echo $_POST[select]; ?>&reason=5">Rain</a> ]
														<?
														}
													}
												}
