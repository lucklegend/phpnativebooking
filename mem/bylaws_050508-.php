...
&nbsp;<table cellSpacing="0" cellPadding="0" width="100%" border="0" id="table8">
					<tr>
					  <td class="houserules">
						...
						Gymnasium</a></li>
						<li style="text-indent:-5px;"><a class="bold" href="http://axonprojects.com/ardmorepark/v3/mem/general.php?crypted=<? echo $_GET['crypted']; ?>#jogging">
						...
						<li style="text-indent:-5px;"><a class="bold" href="http://axonprojects.com/ardmorepark/v3/mem/general.php?crypted=<? echo $_GET['crypted']; ?>#hr">Kitchen at The North Function Room</a></li>
						...
						BBQ Facilities</a></li>
                        <li style="text-indent:-5px;"><a class="bold" href="http://axonprojects.com/ardmorepark/v3/mem/general.php?crypted=<? echo $_GET['crypted']; ?>#UNIFORM">
						Uniform Appearance of Building Facade</a></li>
                        </ol>			
                        <p>&nbsp;&nbsp;<a href="By-laws2008_new.pdf" target="_blank"><img border="0" src="images/d-pdf_02.gif"></a><br/>&nbsp;&nbsp;<span style="font:Arial, Helvetica, sans-serif; font-size:10px">Download the complete by-laws in pdf format.</span>
