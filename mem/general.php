...
type="block"></SPACER></td>
  ...
  <tr align="left" valign="top">
    <td>3.6</td>
    <td class="contentbylaws"><p>Residents shall ensure that all  air-condition equipment, including pipes and hoses are properly maintained. All  discharge pipes shall be directed to the nearest floor trap. Any stains arising  from poorly maintained air-condition equipment to the common areas shall be  cleared/removed by the Management, any costs and expenses thereby incurred  shall be recovered from the person(s) concerned. </td>
  </tr>
  <tr align="left" valign="top">
    <td>3.7</td>
  ...
  <tr align="left" valign="top">
    <td>3.12</td>
    <td class="contentbylaws"> A subsidiary proprietor or an occupier of a lot who owes any contribution or other moneys levied or recoverable by the Management Corporation, or who has breached any by-law, rule or other relevant regulation shall, in the event of the Management Corporation taking any action to enforce and/or recover the same, fully indemnify the Management Corporation’s for all costs and expenses, including the Management Corporation’s legal costs. For the avoidance of any doubt, this by-law shall apply in respect of all actions commenced by the Management Corporation from the date of commencement of this by-law, regardless of whether the subsidiary proprietor’s liability to the Management Corporation, or part thereof, arose prior to the commencement of this by-law. </td>
  </tr>
  <tr align="left" valign="top">
    <td>3.13</td>
    <td class="contentbylaws">   
   							  In addition to the Management's powers of entry under Section 31 of the Building Maintenance and Strata Management Act, where there has been any breach or contravention of any By-law of the Condominium, or any provision, rule, or regulation under any applicable law, the Management (whether by its agents, employees,
contractors, or otherwise) shall have the power to enter any Unit and carry out any work as the Management considers reasonable for the purpose of remedying such breach or contravention, provided always that at least 14 days' written notice of the Management's intention to exercise its power of entry under this Clause is given to the owner/resident, and the breach or contravention remains un-remedied upon the expiry of the time period stated in such written notice.
    </td>
  </tr>
  <tr align="right" valign="top">
    <td>&nbsp;</td>
  ...
  <tr align="left" valign="top">
    <td>4.18</td>
    <td class="contentbylaws">Bicycles should be parked at the designated areas provided in Basement 1 and Basement 2 of the respective Blocks. </td>
  </tr>
  <tr align="left" valign="top">
    <td>4.19</td>
...
<tr align="left" valign="top">
	<td>8.1</td>
	<td class="contentbylaws"><u>Submission & Approval</u></td>
</tr>

<tr align="left" valign="top">
	<td><span class="contentbylaws">8.1.1</span></td>
	<td class="contentbylaws">	The Subsidiary Proprietor shall submit to the Management the prescribed application form for renovation works together with a detailed work schedule at least 10 working days prior to commencement of any renovation works. </td>
</tr>

<tr align="left" valign="top">
	<td>8.1.2 </td>
	<td class="contentbylaws">Subsidiary Proprietor can authorize a representative to apply on his behalf by forwarding an authorization letter to the Management.  </td>
</tr>

<tr align="left" valign="top">
	<td>8.1.3 </td>
	<td class="contentbylaws">Professional Engineer’s (Structural) certification must be obtained from the Panel of Engineers appointed by the Management for any removal of non-structural brick walls.  Any removal of structural members shall be strictly prohibited.  A copy of the certifications must be submitted together with the application for renovation.</td>
</tr>

<tr align="left" valign="top">
	<td>8.1.4 </td>
	<td class="contentbylaws">All electrical work and installation such as re-wiring addition or repositioning of switches, sockets, lighting and power points, etc. must be approved by Qualified Person and relevant plans must be submitted together with the application form to the Management for records.</td>
</tr>

<tr align="left" valign="top">
	<td>8.1.5 </td>
	<td class="contentbylaws">The relevant authorities shall include but not limited to Ministry of National Development, Building and Construction Authority, Urban Redevelopment Authority, Public Utilities Board, Singapore Power Ltd, National Environment Agency and Info-communications Development Authority of Singapore.</td>
</tr>

<tr align="left" valign="top">
	<td>8.1.6 </td>
	<td class="contentbylaws">The endorsement of the Management does not constitute an approval of the relevant authorities. The Subsidiary Proprietor must bear full responsibility to ensure compliance with the building by-laws and other regulations as may be introduced and applicable from time to time.</td>
</tr>

<tr align="left" valign="top">
	<td><span class="contentbylaws">8.1.7</span></td>
	<td class="contentbylaws">	Limitations of the renovation works </td>
</tr>

<tr align="left" valign="top"  >
	<td> 8.1.7.1</td>
	<td class="contentbylaws">	Hacking of existing floor finishes, wall finishes, fixtures, including concealed piping and conduit, and internal partition walls are only allowed for a period of up to 15 working days for the standard unit and 20 working days for the penthouse. Hacking time is limited from 9 am to 3 pm. Such hacking must be accompanied by a Professional Engineer (PE) endorsement to ensure structural integrity and other technical issues are complied with. </td>
</tr>

<tr align="left" valign="top">
	<td>8.1.7.2</td>
	<td class="contentbylaws">All Renovation Works shall be limited to eighty (80) consecutive days (excluding Saturdays, Sundays and Public Holidays) for standard unit and a hundred (100) consecutive days (excluding Saturdays, Sundays and Public Holidays) for penthouses, of which noisy works shall not exceed thirty-five (35) consecutive days for the standard unit or forty (40) consecutive days in the case of a penthouse. All works shall cease upon the expiry of the eighty (80) consecutive days or hundred (100) consecutive days or the number of days approved by the Council (whichever is earlier), unless the Council grants an extension of the duration. Further extension may be granted on a case-by-case basis by Council. </td>
</tr>

<tr align="left" valign="top">
	<td>8.1.7.3 </td>
	<td class="contentbylaws">Each Subsidiary Proprietor shall be limited to one (1) renovation of eighty (80) consecutive days (excluding Saturdays, Sundays and Public Holidays) for standard unit and a hundred (100) consecutive days (excluding Saturdays, Sundays and Public Holidays) for penthouses, of which noisy works shall not exceed thirty-five (35) consecutive days for the standard unit or forty (40) consecutive days in the case of a penthouse per each twelve (12) month period for each unit. Approval for subsequent renovation is subject to the discretion of the Council.</td>
</tr>

<tr align="left" valign="top">
	<td>8.1.8.1</td>
	<td class="contentbylaws">Alteration to any of the external windows</td>
</tr>

<tr align="left" valign="top">
	<td>8.1.8.2</td>
	<td class="contentbylaws">Alteration to any doors or grilles installed in the external walls of the subdivided building </td>
</tr>

<tr align="left" valign="top">
	<td>8.1.8.3</td>
	<td class="contentbylaws">Increasing the permissible load of the floor</td>
</tr>

<tr align="left" valign="top">
	<td>8.1.8.4</td>
	<td class="contentbylaws">The common water and sanitary system</td>
</tr>

<tr align="left" valign="top">
	<td>8.1.8.5	</td>
	<td class="contentbylaws">The common electrical system</td>
</tr>

<tr align="left" valign="top">
	<td>8.1.8.6	</td>
	<td class="contentbylaws">Relocation of refuse chute hopper</td>
</tr>

<tr align="left" valign="top">
	<td>8.1.8.7	</td>
	<td class="contentbylaws">Installation/Diversion of sewerage stack </td>
</tr>

<tr align="left" valign="top">
	<td> 8.1.88	</td>
	<td class="contentbylaws">Installation of any television or radio antenna or equipment on the rooftop or at any external part of the subdivided building<ol><ol><ol></ol></ol></ol></td>
</tr>

<tr align="left" valign="top">
	<td>8.1.8.9</td>
	<td class="contentbylaws">Any works that affect the structural integrity, and / or appearance of the façade and common property of the building. </td>
</tr>

<tr align="left" valign="top">
<td> 8.2</td>
<td class="contentbylaws"><u>Type of Work</u></td>
</tr>

<tr align="left" valign="top">
	<td>8.2.1</td>
	<td class="contentbylaws">External doors, grilles, gates, casement windows or awnings or any tile which are visible from the common areas, if approved by the Management must conform to the design, dimensions, quality and colour specified by the Management.</td>
</tr>

<tr align="left" valign="top">
<td>8.2.1.1</td>
<td class="contentbylaws"> All grilles must be installed within the boundary of the unit and the design, dimensions, quality of the grilles must be in accordance with prevailing specifications approved by the Management.</td>
</tr>

<tr align="left" valign="top">
	<td>8.2.1.2 </td>
	<td class="contentbylaws"> A Subsidiary Proprietor who wishes to carry out any alterationsand/or additions to his/her windows and balconies and tiles that are visible from the common areas is required to obtain prior written approval of the Management. The plans and details of the proposed works must be submitted to the Management at leastone month before the intended date of commencement for suchworks. The Owner shall comply with any terms and conditions that the Management may impose when approving such works. The Management reserves the right to withhold approval forany works that may affect the façade of the building.<p>Materials used for such works and the nature of such alterations and/or additions shall be of complementarydesign and be suitable in nature, quality and appearanceto the existing materials and fittings of the condominium.Without prejudice to the generality hereof, the window frames must be of anodized aluminum and the window panesare of casement type. </td>
</tr>

<tr align="left" valign="top">
<td> 8.2.2	</td>
<td class="contentbylaws"> Subsidiary Proprietor shall not carry out any work that may affect the external façade of the building. Façade shall include windows in the living room, yard areas, common areas, open areas and all other visible parts of the building, which constitute or form part of the external appearance of the development.</td>
</tr>


<tr align="left" valign="top">
	<td> 8.2.3	</td>
	<td class="contentbylaws">Precautions shall be taken against damaging the common concealed electrical wiring and sanitary piping and the floor slab.</td>
</tr>


<tr align="left" valign="top">
	<td>8.2.4	</td>
	<td class"contentbylaws">Subsidiary Proprietor shall not erect additional structures or attach permanent fittings to any balconies or terraces of his unit without the written approval of the Management.</td>
</tr>

<tr align="left" valign="top">
	<td>   8.2.5	</td>
	<td class="contentbylaws"> The Subsidiary Proprietor and his contractor can only carry out the type of work specified in the approval letter given by the Management.</td>
</tr>


<tr align="left" valign="top">
	<td>8.2.6	</td>
	<td class="contentbylaws">The Management shall have the full right and authority to remove/demolish all unauthorized works after giving fourteen (14) days written notice to the Subsidiary Proprietor requesting him to remove the same and all costs and expenses incurred in respect of such removal or demolition shall be borne by the Subsidiary Proprietor. </td>
</tr>

<tr align="left" valign="top">
	<td>8.3		</td>
	<td class="contentbylaws"><u>Working Hours</u></td>
</tr>

<tr align="left" valign="top">
	<td>  8.3.1	</td>
	<td class="contentbylaws">Work can only be carried out within the following times, subject to Clause 8.3.2: <br><br>
<table width="366" border="0" cellspacing="0" cellpadding="0">
<tr align="left" valign="top">
<td width="200">Monday to Friday</td>
<td width="50" align="center">-	</td>
<td width="116">9.00am to 6.00pm</td>
</tr>
</table>
<br />
(No work shall be carried out on Saturdays, Sundays and Public Holidays.<br /></td>
</tr>
...
<tr align="left" valign="top">
<td> 8.3.2	</td>
<td class="contentbylaws"> All hacking, drilling, hammering, grinding or other similar noisy work of any kind whatsoever shall are restricted to a maximum of 6 hours per day on weekdays with breaks in between as follows and subject to Clause 8.3.1:
<br><br>
<table width="366" border="0" cellspacing="0" cellpadding="0">
<tr>
<td width="200">Monday to Friday		</td>
...
<td width="116" >9.00am to 3.00pm</td>
</tr></table></td>
</tr>
...
<tr align="left" valign="top">
<td> 8.3.3	</td>
<td class="contentbylaws">The management shall issue a &quot;<em>STOP WORK ORDER</em>&quot; for up to (7) days for any work carried out beyond the hours stated in 8.3.2 above.</td>
</tr>


<tr align="left" valign="top">
<td>   8.4		</td>
<td class="contentbylaws"><u>Security Deposit</u> </td>
</tr>


<tr align="left" valign="top">
<td>  8.4.1		</td>
<td class="contentbylaws">The Subsidiary Proprietor, occupier, and or his contractor shall place with the Management a security deposit of S$2,000.00 before carrying out the works. </td>
</tr>


<tr align="left" valign="top">
<td>8.4.2	</td>
<td class="contentbylaws"> The security deposit by way of cheque shall be made in favor of "The Management Corporation Strata Title Plan No. 2645" and delivered to the Management Corporation Office at 13 Ardmore Park #01-01 Singapore 259961 during office hours at least 7 days before commencement of any work.</td>
</tr>


<tr align="left" valign="top">
<td> 8.5	</td>
<td class="contentbylaws"><u>	Completion, Fees and Deposit Refund</u></td>
</tr>

<tr align="left" valign="top">
<td>  8.5.1		</td>
<td class="contentbylaws">Upon completion of work, the Subsidiary Proprietor, occupier and/or his contractors shall inform the Management and arrange for a joint site inspection with the Management's representative. Subject to full compliance of all procedures, rules and regulations, herein governing all renovation work and deductions for damages to common property and properties of the occupiers in the building, any unauthorized works, uncleared debris or any inconvenience caused at the building for which the Management would have to incur cost to rectify, the security deposit will be refunded free of interest upon application. Refund of renovation deposits would require minimum of one-month processing period. </td>
</tr>


<tr align="left" valign="top">
<td> 8.5.2		</td>
<td class="contentbylaws">The security deposit shall be forfeited if any of the conditions stated herein are not complied with.  </td>
</tr>


<tr align="left" valign="top">
<td> 8.5.3		</td>
<td class="contentbylaws">Where a Subsidiary Proprietor or occupier and/his contractors of a lot has breached any Prescribed By-Laws under the Building Maintenance and Strata Management Act 2004 and / or breached any By-Laws and / or rules passed by the Management Corporation and where the Management Corporation incurs any costs, fees or expenses whatsoever in enforcing the said By-Laws and /or rules and regulations, the Management Corporation shall recover as a debt all such costs, fees and expenses from the Subsidiary Proprietor or occupier concerned on full indemnity basis. </td>
</tr>


<tr align="left" valign="top">
<td> 8.5.4		</td>
<td class="contentbylaws">In the event of the deposit being insufficient to meet the claim of the Management Corporation, the Subsidiary Proprietor, occupier and/or his contractors shall compensate and pay to the Management Corporation the difference between the said deposit and the amount so claimed by the Management Corporation. This difference due shall be recoverable as a debt to the Management Corporation if remain unpaid. </td>
</tr>

<tr align="left" valign="top">
<td> 8.6		</td>
<td class="contentbylaws"><u>Contractors' Compliance</u> </td>
</tr>


<tr align="left" valign="top">
<td> 8.6.1		</td>
<td class="contentbylaws">All workers of the contractor's company and that of its listed sub-contractors shall inform and register with the security staff at the guard house of their intention to enter the estate prior to the commencement of any work and to exchange for the contractors' passes, failing which the Management reserves the right to refuse entry to any unknown person which cannot be verified there and then.  </td>
</tr>


<tr align="left" valign="top">
<td> 8.6.2	</td>
<td class="contentbylaws">All workers must wear and display the contractor's passes at all times while in the estate. Security officers have the right to question any person in the estate found without a valid contractor's pass.  </td>
</tr>


<tr align="left" valign="top">
<td>8.6.3	</td>
<td class="contentbylaws"> A replacement cost of $30.00 or any other amount prescribed by the Management from time to time will be charged for each lost pass.</td>
</tr>


<tr align="left" valign="top">
<td> 8.6.4		</td>
<td class="contentbylaws"> The contractors must keep our security officer informed of any changes in workmen prior to their deployment at site.</td>
</tr>


<tr align="left" valign="top">
<td> 8.6.5	</td>
<td class="contentbylaws">Contractors and their workers must confine themselves to the work area within the unit. No contractors and/or workers shall be allowed to loiter in any other place.  The estate's recreational facilities are strictly out-of-bounds to contractors and their workers. Contractors and their workers are not allowed to have meals or nap in the common property during their lunch breaks. </td>
</tr>

<tr align="left" valign="top">
<td> 8.6.6	</td>
<td class="contentbylaws"> The Subsidiary Proprietor shall be responsible for the good conduct and behavior of all workers or his listed sub-contractors while they are in the condominium.</td>
</tr>
<tr align="left" valign="top">
<td> 8.6.7		</td>
<td class="contentbylaws"> All workers shall be suitably clothed and shall not use any language or behave in a manner that is likely to cause an offence or embarrassment to the residents/occupiers or any person in the estate. </td>
</tr>


<tr align="left" valign="top">
<td> 8.6.8	</td>
<td class="contentbylaws">Any worker found misbehaving or refusing to comply with security procedures will be removed from the condominium and barred from entry. </td>
</tr>


<tr align="left" valign="top">
<td> 8.7		</td>
<td class="contentbylaws"> <u>Installation of Air-Conditioning Unit(s)</u></td>
</tr>


<tr align="left" valign="top">
<td> 8.7.1		</td>
<td class="contentbylaws">Prior approval of the Management must be obtained before any air-conditioning units are replaced or installed. </td>
</tr>


<tr align="left" valign="top">
<td> 8.7.2		</td>
<td class="contentbylaws">The condensing unit or units and its piping shall be installed within the Owner's air condition ledge. </td>
</tr>


<tr align="left" valign="top">
<td>8.7.3	</td>
<td class="contentbylaws"> All replacement of condensing units if approved by the Management must conform to the design and dimensions as stipulated by Management and installed at the particular positions in the air condition ledge as specified in Appendix B (for One Condensing Unit or Two Condensing Units, where applicable). </td>
</tr>
...
<tr align="left" valign="top">
<td>8.8</td>
<td class="contentbylaws"><u>Lifts & Common Property</u> </td>
</tr>


<tr align="left" valign="top">
<td> 8.8.1		</td>
<td class="contentbylaws"> The contractors shall use only the Service Lift assigned by the Management. The contractors shall be held responsible and accountable for any non-compliance and all costs and expenses including but not limited to legal fees, application costs etc, incurred by the Management upon taking any enforcement action against the contractors. </td>
</tr>


<tr align="left" valign="top">
<td> 8.8.2	</td>
<td class="contentbylaws"> The contractors shall ensure that adequate protection is given to the lobbies, lift walls   and flooring and any other parts of the common property when conveying building materials to and from the unit under renovation. </td>
</tr>
...
<tr align="left" valign="top">
<td> 8.8.3		</td>
<td class="contentbylaws">Halting of lifts by inserting stopper in between lift doors is strictly prohibited. </td>
</tr>
...
<tr align="left" valign="top">
<td>8.8.4		</td>
<td class="contentbylaws"> All materials and debris shall be neatly packed / placed in sacks before loading into the lift.</td>
</tr>


<tr align="left" valign="top">
<td> 8.8.5		</td>
<td class="contentbylaws">No heavy equipment or machinery is allowed in the lift. </td>
</tr>


<tr align="left" valign="top">
<td> 8.8.6		</td>
<td class="contentbylaws">The contractors shall inform the Management of the dates of any delivery to be carried out in the unit. </td>
</tr>


<tr align="left" valign="top">
<td> 8.8.7		</td>
<td class="contentbylaws">Any damage to the common property during the execution of work must be made good by the contractors and is subjected to the acceptance of the Management. </td>
</tr>


<tr align="left" valign="top">
<td> 8.8.8		</td>
<td class="contentbylaws">The estate's common area must not be obstructed at all times. Storage of materials at the common area is strictly prohibited. </td>
</tr>
...
<tr align="left" valign="top">
<td> 8.92	</td>
<td class="contentbylaws"> <u>Protection</u></td>
</tr>


<tr align="left" valign="top">
<td> 8.9.1		</td>
<td class="contentbylaws">The contractors shall ensure adequate protection is put up at windows, balconies or any other openings to prevent debris from falling to units below. </td>
</tr>


<tr align="left" valign="top">
<td> 8.9.2		</td>
<td class="contentbylaws">The contractors shall ensure adequate protection, barricade and partition is placed at the allocated basement car park lots, any common areas or landscape areas for works that could be carried out outside the unit. </td>
</tr>


<tr align="left" valign="top">
<td>   8.10	</td>
<td class="contentbylaws"><u>	Housekeeping/Discipline</u> </td>
</tr>


<tr align="left" valign="top">
<td> 8.10.1		</td>
<td class="contentbylaws">The contractors shall maintain the general cleanliness of the common areas daily. The areas dirtied or soiled by the contractors must be cleaned up immediately to the satisfaction of the Management. </td>
</tr>


<tr align="left" valign="top">
<td> 8.10.2	</td>
<td class="contentbylaws"> Loading/unloading activities should only be carried out at the loading / unloading bays at Basement 2 of Block 15 and or at the delivery car park lots at the back of the service lifts of the respective block. </td>
</tr>


<tr align="left" valign="top">
<td> 8.10.3	</td>
<td class="contentbylaws">No storage space will be provided on site.  All articles/materials/tools/equipment must be stored within the owner's unit at all times. </td>
</tr>

<tr align="left" valign="top">
<td> 8.10.4		</td>
<td class="contentbylaws">No works and washing of tools and equipments will be allowed at commons areas including lift lobbies and stairwells.  </td>
</tr>

<tr align="left" valign="top">
<td>8.10.5</td>
<td class="contentbylaws">All sand must be packed in bags before delivery into the estate.  </td>
</tr>


<tr align="left" valign="top">
<td>8.10.6	</td>
<td class="contentbylaws">Packing and crating materials must be removed and disposed of on the same day as they are being brought in. </td>
</tr>
...
<tr align="left" valign="top">
<td> 8.10.7		</td>
<td class="contentbylaws">Rubbish or building materials shall not be thrown into the chutes or dump in any common areas or washed down in the unit or common floor trap.  </td>
</tr>
...
<td> 8.10.8	</td>
<td class="contentbylaws"> All debris must be removed from the common areas upon completion of work at the end of each day. Unwanted materials and debris should not be left in the corridors, lift lobbies, fire escape staircases or any other common areas. These must be removed daily and the cost incurred, if any, by the Management to remove the debris, will be charged to the Subsidiary Proprietor concerned.</td>
</tr>
...
<td>8.10.9	</td>
<td class="contentbylaws">The contractors shall ensure a doormat is placed at the unit door entrance to prevent workers from dirtying the common areas. All common areas affected during the delivery or removal of materials must be left in a clean and tidy condition on the completion of work each day.  Any damages to the building and its equipment caused by the moving of furniture or other effects during the course of renovation of the unit shall be replaced or repaired at the expenses of the Subsidiary Proprietor concerned. </td>
</tr>
...
<td>8.10.10	</td>
<td class="contentbylaws">The contractors and workers are not allowed to tap water/electricity supply from the common areas. </td>
</tr>
...
<td>  8.10.11</td>
<td class="contentbylaws">The contractors are to comply strictly with all the above-mentioned items 8.10.1 to 8.10.10, failing which all cleaning expenses and related water / electricity costs including but not limited to legal fees, application costs etc, shall be borne by the subsidiary proprietor and his contractor, and / or deducted from the security deposit.</td>
</tr>
...
<td> 8.11		</td>
<td class="contentbylaws"><u>Vehicles</u> </td>
</tr>
...
<td>8.11.1	</td>
<td class="contentbylaws">No heavy vehicles, lorries, trucks and any vehicles used for the renovation exceeding the height of 2.1m clearance or more than 20 feet in length is allowed in the estate and basement car park.   </td>
</tr>

<tr align="left" valign="top">

<td> 8.11.2	</td>
<td class="contentbylaws">All vehicles used for the renovation work must be parked at the delivery car park lots designated for service providers and must not cause any obstruction. </td>
</tr>

<tr align="left" valign="top">

<td> 8.2.2	</td>
<td class="contentbylaws"><u>Re-waterproofing work</u></td>
</tr>

<tr align="left" valign="top">

<td> 8.12.1		</td>
<td class="contentbylaws">The contractors must ensure that re-waterproofing works are carried out at all wet areas, namely bathrooms, kitchens, wash areas and balconies where hacking works have been carried out. A copy of the waterproofing warranty shall be submitted to the Management for record purposes before any refund of security deposit will be made.</td>
</tr>

<tr align="left" valign="top">

<td> 8.13		</td>
<td class="contentbylaws"><u>Dust Control </u></td>
</tr>
...
<td> 8.13.1		</td>
<td class="contentbylaws">The contractors shall carry out adequate dust control measures for instance, using vacuum cleaner to pick up dust while drilling or to close required doors to prevent dust and debris from escaping to the neighbouring units or common areas, etc throughout the renovation period. </td>
</tr>
...
<td> 8.14		</td>
<td class="contentbylaws"> <u>Noise Control</u></td>
</tr>
...
<td> 8.14.1</td>
<td class="contentbylaws">The contractors shall ensure noisy works are carried out during the permitted hours stipulated under clause 8.3.2. </td>
</tr>

<tr align="left" valign="top">

<td>8.14.2	</td>
<td class="contentbylaws">The contractors shall ensure reasonable and adequate noise mitigation measures are carried out throughout the renovation period to prevent noise disturbance to other residents.  The noise level generated from the renovating unit shall be kept within the acceptable standard approved by National Environment Agency (NEA).  </td>
</tr>
...
<td> 8.14.3		</td>
<td class="contentbylaws"> Noisy works such as cutting of tiles, pipes, timber and carpentry works etc must be carried out within the unit and are not permitted at the common areas including the service lift lobbies and stairwells. The contractors shall be held responsible and accountable for any non-compliance and all costs and expenses including but not limited to legal fees, application costs etc, incurred by the Management upon taking any enforcement action against the contractors. </td>
</tr>
...
<tr align="left" valign="top">
<td> 8.14.4	</td>
<td class="contentbylaws">The Management reserves the right to stop any works that interfere with the quiet and peaceful enjoyment of any residents.  </td>
</tr>
...
<tr align="left" valign="top">
<td>8.15</td>
<td class="contentbylaws"><u>Smell / Odour</u> </td>
</tr>
...
<td>8.15.1	</td>
<td class="contentbylaws"> In the event that any parquet, carpentry, painting, furniture works or any works that emit smell or odour, are to carried out in the apartment, the Subsidiary Proprietor, occupier and or his contractors or any person for whom the contractor are responsible for, including the contractor's employees or workers or agents or any sub-contractors, whether direct or indirect, and their employees or workers or agents must ensure that during the process of carrying out the works, that the areas are ventilated with all smell and odour completely eliminated. They must ensure that all openings such as floor traps, sink holes etc are properly sealed to prevent any egress of smell or odour to neighbouring units in the block so as not to cause undue distress and or nuisance to the residents in the block. </td>
</tr>
...
<td> 8.16</td>
<td class="contentbylaws"><u>Others</u> </td>
</tr>
...
<td>8.16.1	</td>
<td class="contentbylaws">The Subsidiary Proprietors and or Occupiers and or Contractors will be liable for and must indemnify the Management against all liability, loss, claims or proceedings arising out of or in the course of the execution of work. </td>
</tr>
...
<td>8.16.2	</td>
<td class="contentbylaws">Should the Subsidiary Proprietors and or Occupiers and or Contractors found to breach any of the by-laws stipulated herewith, the Management shall bar the contractor from entering the estate for a minimum period of six (6) months. </td>
</tr>
...
<td>8.16.3	</td>
<td class="contentbylaws">The Subsidiary Proprietor and or Occupiers and or Contractors shall allow the council members/managing agent of the Management access into the unit under renovation for the purpose of checking of any unauthorized work. </td>
</tr>
<tr align="left" valign="top">
  <td>8.16.4 </td>
  <td class="contentbylaws">The Subsidiary Proprietor and or Occupiers and or Contractors shall submit workmen’s compensation and public liability policies with an indemnity of $2 million for each respective policy to the Management before commencement of work. </td>
</tr>
<tr align="left" valign="top">

<td>8.16.5	</td>
<td class="contentbylaws">The Subsidiary Proprietor and or Occupiers and or Contractors shall submit a copy of the Risk Assessment Report as stipulated under the Workplace Health and Safety Act to the Management before commencement of work.  <br />
  <br /></td>
</tr>
<tr align="left" valign="top">
...
<table width="100%" cellspacing="0" cellpadding="15" border="1"style="border:solid; border:thin">
<tr>
<td>Disclaimer:<br></br>The Management in its absolute discretion reserves the right to reject any applicant and revoke any permit granted.  The Management shall not be liable for any damage arising from the rejection of the application or revocation of the permit.</td>
</tr></table></td>
</tr>
...
-->
  ...
  <tr align="left" valign="top">
    <td>9.14</td>
    <td class="contentbylaws">Insurance<br>
      <br>
      ...
      <br>
      <br>
      <p>(a)&nbsp;&nbsp;&nbsp;&nbsp;Workmen&acute;s Compensation<br>
        <br>
        (b)&nbsp;&nbsp;&nbsp;&nbsp;Third Party Liability up to a minimum cover of $1 million for any one   accident.<br>
        <br>
        (c)&nbsp;&nbsp;&nbsp;&nbsp;Any other insurance which the Management may deem necessary.<br>
        <br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Copies of the above insurance policies shall be lodged with the Management before the commencement of Renovation Works, Bulk Delivery and <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;House Removal. <br></p>      </td>
  </tr>
  <tr align="right" valign="top">
    <td>&nbsp;</td>
    <td><a href="javascript:history.back(-1)">
  ...
  <tr align="left" valign="top">
    <td>11.6</td>
    <td class="contentbylaws">Pet owners are responsible for cleaning up all litters and droppings from their pets whilst walking them in the common areas. All cleaning expenses and costs of damages to common areas including but not limited to legal fees, application costs etc, undertaken by the Management shall be borne by the owners / residents for any non-compliance. </td>
  </tr>
  <tr align="left" valign="top">
    <td>11.7</td>
  ...
  <tr align="left" valign="top">
    <td>18.7</td>
    <td class="contentbylaws">Residents must make payment of the deposit at the Management Office within 72
hours of the booking, failing which the function room will be made open for booking again.</td>
  </tr>
  <tr align="left" valign="top">
    <td>18.8</td>
  ...
  <tr align="left" valign="top">
    <td>19.11</td>
    <td class="contentbylaws">Only coaches accredited/sanctioned by the Management are permitted to conduct training sessions in the gymnasium. Only residents are permitted to take training sessions. Invitees and non-residents are not allowed to participate in training sessions with residents. Management reserves the right to bar coaches and residents from usage of the gymnasium facility for non-compliance.</td>
  </tr>
  <tr align="left" valign="top">
    <td>19.12</td>
  ...
  <tr align="left" valign="top">
    <td>26.9</td>
    <td class="contentbylaws">The Resident must make payment of the deposit at the Management Office within 72
hours of the booking, failing which the BBQ facility will be made open for booking again.</td>
  </tr>
  <tr align="left" valign="top">
    <td>26.10</td>
    <td class="contentbylaws">Cancellation of bookings shall be made at least 3 days before the date booked.</td>
  ...
  <tr align="left" valign="top">
    <td>(a)</td>
    <td class="contentbylaws"><p>No laundry,  bedding, clothing or any other articles shall be hung at the balconies or by  the windows in such manner as to be visible from the exterior of the subdivided  building. The owners / residents in breach of this by-law shall be held  responsible and accountable for any costs and expenses including any legal or  professional fees incurred by the Management in respect of such action  undertaken by Management to ensure that owners/ residents comply with the  above. </p></td>
  </tr>
  <tr align="left" valign="top">
    <td>(b)</td>
  ...
  <tr align="left" valign="top">
    <td>28.1.1</td>
    <td class="contentbylaws">The two booking sessions for the Entertainment Room are: <br>
      <br>
  ...
  <tr align="left" valign="top">
    ...
    <td class="contentbylaws">Each residence is entitled to book for 1 Session per week.</td>
  </tr>
  <tr align="left" valign="top">
  ...
  <tr align="right" valign="top">
    ...
    <td class="contentbylaws">Residents must make payment of the deposit at the Management Office within 72
hours of the booking, failing which the Entertainment Room will be made open for booking again.</td>
  </tr>
  <tr align="right" valign="top">
