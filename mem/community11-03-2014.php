...
<!--Car Park Resurfacing Works Phase 11.pdf-->
                ...
                <p><a href="bulletin/CLEANINGOFOVERHEADPIPES-FLOORSCRUBBINGATBLOCK9and11BASEMENT-1.pdf" target="_blank"><img border="0" src="painting1_new.jpg" width="340" height="112" style="border: 1px solid #800000" /></a></p>
                <a href="CLEANING OF OVERHEAD PIPES-FLOOR SCRUBBING AT BLOCK 9and11 (BASEMENT 1).pdf">
                <!--end !-->
				</a>
                <table id="table9">
                    ...
                    <tr>
						<td>&nbsp;</td>
						<td vAlign="top" align="middle">
						  <a href="bulletin/CLEANINGOFOVERHEADPIPES-FLOORSCRUBBINGATBLOCK9and11BASEMENT-1.pdf"><img height="7" src="img/leftdot.gif" width="9" vspace="4"></a></td>
						<td vAlign="top" align="left">
						  <a href="bulletin/CLEANINGOFOVERHEADPIPES-FLOORSCRUBBINGATBLOCK9and11BASEMENT-1.pdf">
						  <? echo change_format($row['date_start']); ?></a></td>
						<td vAlign="top" align="left"><a href="bulletin/CLEANINGOFOVERHEADPIPES-FLOORSCRUBBINGATBLOCK9and11BASEMENT-1.pdf"><? echo $row['title']; ?></a></td>
					</tr>
                    <?
					}
					?>
