...
height="3"><b><br>
        ...
        <tr> 
          <td class="leftcontent" height="69"><a href="admin.php?crypted=<? echo $_GET['crypted']; ?>">&nbsp;&nbsp;</a><a href="http://helpdesk.axonhq.net" target="_blank"><img height="7" src="img/leftdot.gif" width="9" border="0"></a><a href="admin.php?crypted=<? echo $_GET['crypted']; ?>"> 
            Main Menu </a><br>
            <a href="admin.php?crypted=<? echo $_GET['crypted']; ?>">&nbsp;&nbsp;</a><a href="http://helpdesk.axonhq.net" target="_blank"><img height="7" src="img/leftdot.gif" width="9" border="0"> 
            </a><a class="copy" href="admin.php?mode=password&crypted=<? echo $_GET['crypted']; ?>">Change 
            Password </a><br>
          </td>
        </tr>
        <tr> 
          <td class="leftdecline" height="3"><spacer type="block" 
height="3"><b><br>
            &nbsp;&nbsp;System Management</b></spacer></td>
        </tr>
        <tr> 
          <td class="leftcontent" height="3"><a href="facility.php?crypted=<?php echo $_GET[crypted]; ?>&page=user"><br>
            &nbsp;&nbsp;</a><a href="http://helpdesk.axonhq.net" target="_blank"><img height="7" src="img/leftdot.gif" width="9" border="0"></a><a href="facility.php?crypted=<?php echo $_GET[crypted]; ?>&page=user"> 
            Manage Users</a><br>
            <a href="booking.php?crypted=<?php echo $_GET[crypted]; ?>&cr=1">&nbsp;&nbsp;</a><a href="http://helpdesk.axonhq.net" target="_blank"><img height="7" src="img/leftdot.gif" width="9" border="0"></a><a href="booking.php?crypted=<?php echo $_GET[crypted]; ?>&cr=1"> 
            Manage Facilities</a><br>
            <a href="comm.php?crypted=<? echo $_GET['crypted']; ?>&calender">&nbsp;&nbsp;</a><a href="http://helpdesk.axonhq.net" target="_blank"><img height="7" src="img/leftdot.gif" width="9" border="0"></a><a href="comm.php?crypted=<? echo $_GET['crypted']; ?>&calender"> 
        ...
        <tr> 
          <td class="leftdecline" height="3"><spacer type="block" 
height="3"><b><br>
            &nbsp;&nbsp;Content Management</b></spacer></td>
        </tr>
        <tr> 
          <td class="leftcontent" height="3"><a href="facility.php?crypted=<?php echo $_GET[crypted]; ?>&page=user"><br>
            &nbsp;&nbsp;</a><a href="http://helpdesk.axonhq.net" target="_blank"><img height="7" src="img/leftdot.gif" width="9" border="0"></a> 
            <a href="armenities.php?crypted=<? echo $_GET['crypted']; ?>">Amenities</a><br>
            <a href="booking.php?crypted=<?php echo $_GET[crypted]; ?>&cr=1">&nbsp;&nbsp;</a><a href="http://helpdesk.axonhq.net" target="_blank"><img height="7" src="img/leftdot.gif" width="9" border="0"></a><a href="booking.php?crypted=<?php echo $_GET[crypted]; ?>&cr=1"> 
            </a><a href="addforms.php?crypted=<? echo $_GET['crypted']; ?>">Application 
            Forms</a><br>
            <a href="comm.php?crypted=<? echo $_GET['crypted']; ?>&calender">&nbsp;&nbsp;</a><a href="http://helpdesk.axonhq.net" target="_blank"><img height="7" src="img/leftdot.gif" width="9" border="0"></a><a href="comm.php?crypted=<? echo $_GET['crypted']; ?>&calender"> 
            </a><a href="newsmgmt.jsp">News / Circulars</a><br>
            <a href="comm.php?crypted=<? echo $_GET['crypted']; ?>&calender">&nbsp;&nbsp;</a><a href="http://helpdesk.axonhq.net" target="_blank"><img height="7" src="img/leftdot.gif" width="9" border="0"> 
            </a><a href="hmsvcmgmt.jsp?ty=useful info">Useful Info</a><span class="txtgrey"></span><a href="http://helpdesk.axonhq.net" target="_blank"> 
...
height="3"><b><br>
            &nbsp;&nbsp;Reports<br>
            <br>
            </b><a href="bookmgmt.jsp">&nbsp;&nbsp;</a><a href="http://helpdesk.axonhq.net" target="_blank"><img height="7" src="img/leftdot.gif" width="9" border="0"></a><a href="bookmgmt.jsp"> 
            Pending Payments</a><br>
            <a href="facility.php?crypted=<?php echo $_GET[crypted]; ?>&page=user">&nbsp;&nbsp;</a><a href="http://helpdesk.axonhq.net" target="_blank"><img height="7" src="img/leftdot.gif" width="9" border="0"></a><a href="facility.php?crypted=<?php echo $_GET[crypted]; ?>&page=user"> 
            Booking Report</a><br>
            <a href="facility.php?crypted=<?php echo $_GET[crypted]; ?>&page=user">&nbsp;&nbsp;</a><a href="http://helpdesk.axonhq.net" target="_blank"><img height="7" src="img/leftdot.gif" width="9" border="0"> 
            </a><a href="facility.php?crypted=<?php echo $_GET[crypted]; ?>&page=user">Cancelled 
            Report</a><b><a href="facility.php?crypted=<?php echo $_GET[crypted]; ?>&page=user"> 
            </a><br>
            <br>
            </b></SPACER></td>
        </tr>
        <tr> 
          <td class="leftdecline" height="21"><b>&nbsp;&nbsp;AXON Support</b></td>
        </tr>
        <tr> 
          <td class="leftdecline" height="3"><a href="http://helpdesk.axonhq.net" target="_blank"><br>
      ...
      <?php
		...
		}elseif($_GET[page] =='user' and $user_type =='1')
		{
		?>
