...
if(isset($_POST['szID']))
{
	...
	$query  = "SELECT * FROM user_account WHERE username = '". mysqli_real_escape_string($conn,$_POST['szID'])."' and password = '". mysqli_real_escape_string($conn, $_POST['szPassword'])."' and active = '1'";
	$result = mysqli_query($conn, $query) or die(mysqli_error($conn));
...
<table width="100%"  border="0" cellpadding="0" cellspacing="0" id="tableOne">
  <tr>
  ...
  <tr>
   ...
   <?php
		...
		}else{ //FOR if(isset($_SESSION['basic_is_logged_in']) && isset($_GET['crypted']))
		?>
  	<form name="form1" method="post" action="" onSubmit="return validate()">
		<input type="hidden" name="c" value="1">
		<tr>
		  <td width="15" align="left">&nbsp;</td>
		  <td width="116" align="left" valign="top" class="leftlogin1">
		  	<img src="img/t/leftlogin.gif" width="37" height="13" vspace="10">
		  </td>
		  <td width="19">&nbsp;</td>
		</tr>
		<tr>
      ...
      <tr>
        <td width="150" colspan="3" valign="top">      
        	...
        	<center> 
						...
						<a href="http://www.counterdata.com/details.php?page=282756&amp;print_page=http://www.ascengen.com/ardmorepark/home.jsp" title="http://www.ascengen.com/ardmorepark/home.jsp Stats" target="_blank" style="font-family: Geneva, Arial, Helvetica, sans-serif; font-size: 10px; color: #000000; text-decoration: none;"></a>
						<br><!--<a href="http://www.top-us-sites.com/payday-loans.html" target="_blank">-->
							<img src="http://www.counterdata.com/count.php?page=282756&amp;style=0505018&amp;nbdigits=6&amp;reloads=1" alt="" border="0" ><!-- </a> --><br>
						<!-- counterdata.com -->
        	</center>
        <!-- Web counter - end -->
					<br>
...
Ardmore Park redefines modern luxury living with a stylish lavishness and exclusive address that is the definitive residence for the well established. The sprawling 8 acres make Ardmore Park one of the largest freehold sites in a prime residential location in Singapore and it is set on high land enjoying island wide views.</p>
    ...
    <td width="29" align="right" valign="top" class="ctrrgt"><img src="img/ctrrighttop.gif" width="29" height="82"></td>
	  <td width="163" valign="top"><p>&nbsp;</p>
	  	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
	        <tr>
	          <td>
	          	<a href="walkthrough.php?crypted=<?php if (isset($_SESSION['basic_is_logged_in']) && isset($_GET['crypted'])){ echo $_GET['crypted']; } ?>">
	        ...
	        <tr>
	          <td>
	          	<a href="gallery.php?crypted=<?php if (isset($_SESSION['basic_is_logged_in']) && isset($_GET['crypted'])){ echo $_GET['crypted']; } ?>">
	          		<img src="img/rgtphotol.jpg" width="163" height="141" border="0" />
	          	</a>
	          	<a href="gallery.php?crypted=<?php if (isset($_SESSION['basic_is_logged_in']) && isset($_GET['crypted'])){ echo $_GET['crypted']; } ?>"></a>
	          </td>
	        </tr>
	        <tr>
	          <td>
	          	<a href="facsiteplan.php?crypted=<?php if(isset($_SESSION['basic_is_logged_in']) && isset($_GET['crypted'])) { echo $_GET['crypted']; } ?>">
  ...
  <tr>
    <td background="img/leftbotbg.gif">
    	<spacer type="block" height="20">
    </td>
	  <td align="left" valign="top" background="img/ctrbotctr.gif">
	  		<img src="img/ctrleftbot.gif" width="29" height="20">
	  </td>
	  <td valign="top" class="ctrbot">&nbsp;</td>
	  <td align="right" valign="top" background="img/ctrbotctr.gif">
	  	<img src="img/ctrrgtbot.gif" width="29" height="20">
	  </td>
	  <td valign="top">&nbsp;</td>
  </tr>
</table>
