		...
		<table cellSpacing="0" cellPadding="10" width="100%" id="table7">
			<tr>
			  <td vAlign="top" width="82%">
				<h3>Contractors / Suppliers guidelines list for Ardmore Park residents <font color="#FF0000">*</font></h3>
				<hr><br>
&nbsp;
<table cellspacing="0" cellpadding="5" width="100%" border="0" id="table8">
  ...
  <tr>
	...
	<td class="bk" valign="top" width="30%" height="20" style="padding: 5px;"> <? if ($rowcontractors['url'] != '') { ?><a class="gettingthere" href="http://<? echo $rowcontractors['url']; ?>" target="_blank"><? } ?><strong><? echo $rowcontractors['display_name']; ?></strong><? if ($rowcontractors['url'] != '') { ?></a><? } ?><br />
...
<font color="#FF0000">* This is only a guide. Owners / residents are free to use their own contractors.</font></td>
			</tr>
		</table>
</td>
