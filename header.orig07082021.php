  ...
  <tr>
    <td height="122" valign="top" background="img/top_bg.gif"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="37%" align="right" valign="top"><a href="home.php<? if (isset($_GET['crypted'])) echo "?crypted=" . $_GET['crypted']; ?>"><img src="img/but_hm.gif" width="23" height="26" vspace="12" border="0"></a></td>
        <td width="6%" align="center" valign="top"><a href="sitemap.php<? if (isset($_GET['crypted'])) echo "?crypted=" . $_GET['crypted']; ?>"><img src="img/but_sitemap.gif" width="35" height="28" vspace="12" border="0"></a></td>
      </tr>
		</table>
...
<a href="contact_us.php<? if (isset($_GET['crypted'])) echo "?crypted=" . $_GET['crypted']; ?>"><img src="img/but_contact_1.gif" onMouseOver="this.src='img/but_contact_2.gif'" onMouseOut="this.src='img/but_contact_1.gif'" alt="Contact Us" title="Contact Us" width="88" height="22" border="0"></a></td>
        </tr>
    </table></td>
  </tr>
</table>